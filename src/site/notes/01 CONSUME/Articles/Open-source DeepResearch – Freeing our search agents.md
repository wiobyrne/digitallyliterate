---
{"dg-publish":true,"permalink":"/01-consume/articles/open-source-deep-research-freeing-our-search-agents/","title":"Open-source DeepResearch – Freeing our search agents"}
---
...
- [TLDR](https://huggingface.co/blog/#tldr "TLDR")
- [Table of Contents](https://huggingface.co/blog/#table-of-contents "Table of Contents")
- [What are Agent frameworks and why they matter?](https://huggingface.co/blog/#what-are-agent-frameworks-and-why-they-matter "What are Agent frameworks and why they matter?")
- [The GAIA benchmark](https://huggingface.co/blog/#the-gaia-benchmark "The GAIA benchmark")
- [Building an open Deep Research](https://huggingface.co/blog/#building-an-open-deep-research "Building an open Deep Research")
- [Using a CodeAgent](https://huggingface.co/blog/#using-a-codeagent "Using a CodeAgent")
- [Making the right tools 🛠️](https://huggingface.co/blog/#making-the-right-tools-%F0%9F%9B%A0%EF%B8%8F "Making the right tools 🛠️")
- [Results 🏅](https://huggingface.co/blog/#results-%F0%9F%8F%85 "Results 🏅")
- [Community Reproductions](https://huggingface.co/blog/#community-reproductions "Community Reproductions")
- [Most important next steps](https://huggingface.co/blog/#most-important-next-steps "Most important next steps")TLDR
...
- [Making the right tools 🛠️](https://huggingface.co/blog/#making-the-right-tools-%F0%9F%9B%A0%EF%B8%8F)
- [Results 🏅](https://huggingface.co/blog/#results-%F0%9F%8F%85)
