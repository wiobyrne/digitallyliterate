---
{"dg-publish":true,"permalink":"/01-consume/articles/huggingfaceopen-r1-fully-open-reproduction-of-deep-seek-r1/","title":"huggingface/open-r1: Fully open reproduction of DeepSeek-R1","tags":["open-r1"]}
---
...
1. [Overview](https://github.com/huggingface/#overview)
2. [Plan of attack](https://github.com/huggingface/#plan-of-attack)
3. [Installation](https://github.com/huggingface/#installation)
4. [Training models](https://github.com/huggingface/#training-models)
- [SFT](https://github.com/huggingface/#sft)
- [GRPO](https://github.com/huggingface/#grpo)
5. [Evaluating models](https://github.com/huggingface/#evaluating-models)
6. [Reproducing Deepseek's evaluation results](https://github.com/huggingface/#reproducing-deepseeks-evaluation-results)
7. [Data generation](https://github.com/huggingface/#data-generation)
- [Generate data from a smol distilled R1 model](https://github.com/huggingface/#generate-data-from-a-smol-distilled-r1-model)
- [Generate data from DeepSeek-R1](https://github.com/huggingface/#generate-data-from-deepseek-r1)
8. [Contributing](https://github.com/huggingface/#contributing)
...
Following [s1: Simple test-time scaling](https://arxiv.org/abs/2501.19393) the data can be decontaminated using the script at: [scripts/decontaminate.py](https://github.com/huggingface/open-r1/blob/main/scripts/decontaminate.py), which decontaminates a dataset using 8-grams and deduplicate the data. Sample run:
...
*Source: [huggingface/open-r1: Fully open reproduction of DeepSeek-R1](https://github.com/huggingface/open-r1)*
