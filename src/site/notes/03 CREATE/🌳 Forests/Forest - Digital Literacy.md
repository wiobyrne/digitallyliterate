...
| 6. The Bigger Picture | All four | AI, surveillance, and the future of digital agency | Synthesis + call to action |
...
- **Grove: AI Literacy** — How do AI tools (LLMs, generative media, agentic systems) change the digital literacy landscape? The [[02 DEVELOP/🌿 Plants/AI Safety Spending Gap\|AI Safety Spending Gap]] seed is a start, but this needs its own Grove connecting AI sycophancy, model behavior, and educational implications.
...
- Where does AI fit as a fifth pillar vs. a thread running through all four?
