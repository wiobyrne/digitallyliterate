---
{"dg-publish":true,"dg-permalink":"tldr-161","permalink":"/tldr-161/","title":"Too Long; Didn't Read Issue 161","tags":["digital-literacy","education-technology","digital-detox","screentime-research","kristen-turner","flipgrid","critical-readers","critical-writers","online-spaces","bill-nye","climate-change","horizon-report","educause","learning-spaces","oer","alex-jones","infowars","content-moderation","hate-speech","twitter-suspension","platform-accountability","google-tracking","location-data","privacy-settings","digital-literacies-planning","michelle-hagerman","relationships-over-rules","listening","messy-spaces","hypothesis","annotated-syllabus","remi-kalir","open-pedagogy","aretha-franklin","resilience"],"dg-note-properties":{"title":"Too Long; Didn't Read Issue 161","created":"2018-08-17","last_updated":"2025-12-13","status":"evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","digital-detox","screentime-research","kristen-turner","flipgrid","critical-readers","critical-writers","online-spaces","bill-nye","climate-change","horizon-report","educause","learning-spaces","oer","alex-jones","infowars","content-moderation","hate-speech","twitter-suspension","platform-accountability","google-tracking","location-data","privacy-settings","digital-literacies-planning","michelle-hagerman","relationships-over-rules","listening","messy-spaces","hypothesis","annotated-syllabus","remi-kalir","open-pedagogy","aretha-franklin","resilience"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[Alex Jones Deplatforming\|Alex Jones Deplatforming]]","[[Google Location Tracking\|Google Location Tracking]]","[[Hypothesis Pedagogy\|Hypothesis Pedagogy]]","[[Relationships Over Rules\|Relationships Over Rules]]"],"shelf":"archived","description":"Issue 161 what are the normal people up to returns from two-week digital detox launching screentime research project with Kristen Turner using Flipgrid, Alex Jones suspension timeline raising questions about content moderation hate speech and platform accountability, Google location tracking continuing even when disabled violating privacy expectations, digital literacies planning guidance from Michelle Hagerman, importance of relationships and listening over rigid rules in messy human spaces, and Remi Kalir's annotated syllabus using Hypothesis for open pedagogy making learning more relevant and accessible."}}
---
...
**Published**: 2018-08-17 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]
...
- [Helping Students, Teachers, & Parents make sense of the screen time debate](https://www.literacyworldwide.org/blog/literacy-daily/2018/08/03/helping-students-teachers-and-parents-make-sense-of-the-screentime-debate) - I started up a research project with Kristen Turner, and we'd like for you to get involved. We're trying to start up a discussion across a number of groups on the topic of "screentime." What is it? What are the challenges? How do others deal with it. You can read more at the post above, or go directly to our [website](https://screentime.me/). We're using [Flipgrid for this research](https://flipgrid.com/screentime) if you'd prefer.
- [Empowering students as critical readers and writers in online spaces](https://www.emeraldinsight.com/doi/abs/10.1108/S2048-045820180000009018) - My chapter in the text, Best Practices in Teaching Digital Literacies, was finally published. In this piece, I tie together my work and research from the past decade on the topic to identify what it all means. Email me if you'd like a copy.

---

## 🔖 Key Takeaways

- **Alex Jones Deplatforming**: Platforms removing Infowars content for hate speech raises fundamental questions about who decides acceptable online speech and whether tech companies should enforce these standards.
- **Google Location Betrayal**: Investigation reveals Google continues tracking location even when privacy settings explicitly disable it demonstrating gap between user expectations and actual data practices.
- **Screentime Research Launch**: New project invites community participation exploring what screentime means, challenges it creates, and how people navigate device use across contexts.
- **Relationships Over Rules**: Digital detox and face-to-face time reinforces importance of listening and sitting with disagreement in messy human spaces where truth often lives.
- **Open Pedagogy Practice**: Annotating syllabi with Hypothesis creates opportunities for collaborative learning making courses more accessible and relevant through shared annotation.

---

## 📺 Watch

### [Bill Nye on Climate Change](https://www.youtube.com/watch?v=EtW2rrLHs08)
...
Also, if you're a Netflix user, you should watch the new series, [Bill Nye Saves the World](https://www.netflix.com/title/80117748).
...
### [2018 Horizon Report](https://library.educause.edu/resources/2018/8/2018-horizon-report)
...
Educause [stepped in](https://www.insidehighered.com/news/2018/02/06/educause-plans-buy-assets-bankrupt-new-media-consortium) this year to continue the work of the Horizon project after the NMC unexpectedly declared bankruptcy and ceased operations at the end of 2017.

This latest report highlights:
- Redesigns in learning spaces
- Removing barriers for students
- Growth of open educational resources (OERs)
- Rise of analytics and AI in education
- Challenges of digital equity and access
...
### [A Timeline of Vacillation: How Twitter Came to Suspend Alex Jones](https://www.theringer.com/tech/2018/8/16/17705492/a-timeline-of-vacillation-how-twitter-came-to-suspend-alex-jones)
...
This content was banned over the last ten days on [Facebook](https://www.huffingtonpost.com/entry/facebook-removes-alex-jones-info-wars_us_5b683f02e4b0de86f4a35b5c), [Apple](https://www.huffingtonpost.com/entry/apple-removes-alex-jones-and-infowars-podcasts-from-itunes_us_5b67c30de4b0b15abaa49846), [Spotify](https://www.huffingtonpost.com/entry/spotify-infowars-alex-jones_us_5b61c4d2e4b0b15aba9ec86e), and [YouTube](https://www.cnbc.com/2018/08/06/youtube-removes-alex-jones-account-following-earlier-bans.html). Each of these tools identified Jones' content as hate speech and as such against their terms of use.

Twitter, on the other hand, was slow to respond to Jones in any capacity, until they finally suspended him for seven days this week. This has been met by many calls for individuals to [leave Twitter](https://boingboing.net/2018/08/12/im-joining-the-campaign-to-d.html). As I write this newsletter, today (August 17th, 2018) is labeled as D-Day in which groups have amassed to [delete Twitter](https://lifehacker.com/its-time-to-quit-twitter-1828307515) and send a signal to the company.
...
Click through the [interactive section](https://interactives.ap.org/google-location-tracking/) of the post to get a better idea of what this data looks like plotted on a map to see if you would be fine with this.
...
### [Six ways to plan for digital literacies learning](https://www.literacyworldwide.org/blog/literacy-daily/2017/07/28/six-ways-to-plan-for-digital-literacies-learning)
...
### [Relationships matter more than rules](https://www.edutopia.org/article/relationships-matter-more-rules)
...
### [Annotate Your Syllabus](http://remikalir.com/courses/annotate-your-syllabus/)

I've talked (and [written](https://wiobyrne.com/?s=hypothesis)) quite a bit about my use of Hypothesis in my own personal work, as well as in my teaching.
...
The approach:
- Post syllabus as public webpage
- Enable Hypothesis annotation
- Invite students to annotate with questions, suggestions, connections
- Instructor responds to annotations
- Syllabus becomes living document rather than static contract
...
**Previous**: [[03 CREATE/33 Newsletter/TLDR 160\|TLDR 160]] • **Next**: [[03 CREATE/33 Newsletter/TLDR 162\|TLDR 162]] • **Archive**: [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

**🌱 Connected Concepts**:

- [[Alex Jones Deplatforming\|Alex Jones Deplatforming]] — Timeline of platforms removing Infowars content for hate speech raises questions about [[Content Moderation\|Content Moderation]] standards, whether tech companies should enforce speech norms, and tensions between free expression and preventing harm in [[Platform Governance\|Platform Governance]].
- [[Google Location Tracking\|Google Location Tracking]] — Investigation reveals Google continues tracking location even when privacy settings disable it demonstrating gap between user expectations and actual [[Data Practices\|Data Practices]] representing dark pattern at scale in [[Privacy Violations\|Privacy Violations]].
- [[Hypothesis Pedagogy\|Hypothesis Pedagogy]] — [[Remi Kalir\|Remi Kalir]] annotated syllabus approach transforms course documents into collaborative meaning-making using social annotation enabling students to co-create understanding in [[02 CURATE/Open Pedagogy\|Open Pedagogy]] practices.
- [[Relationships Over Rules\|Relationships Over Rules]] — Digital detox reinforces importance of sitting with others and listening in messy spaces where disagreement provides opportunity for genuine [[02 CURATE/Human Connection\|Human Connection]] beyond quick takes and definitive positions dominant in [[Online Discourse\|Online Discourse]].
- [[Screentime Research Project\|Screentime Research Project]] — New project with [[Kristen Turner\|Kristen Turner]] invites community participation exploring what screentime means, challenges it creates, and how people navigate device use in [[Digital Wellbeing\|Digital Wellbeing]] research.
