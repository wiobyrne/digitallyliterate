---
{"dg-publish":true,"dg-permalink":"tldr-183","permalink":"/tldr-183/","title":"Focusing on Importance","tags":["digital-literacy","education-technology","defining-digital-literacy","workgroups","literacy-educators","grayscale-phones","peergrade","peer-review","student-feedback","marie-forleo","mark-manson","subtle-art","focusing-importance","nsfw-language","new-yorker","internet-retrospective","tech-moments","privacy-concerns","data-security","nostalgia-tech","facebook-vpn","teen-data-collection","project-atlas","13-to-35-users","20-dollar-payment","total-phone-access","apple-blocks-facebook","data-scandals","pattern-behavior","spying-users","selling-advertisers","obfuscation","transparency-blocks","zuckerberg-delusion","consumer-content","tailored-ads","ad-personalization","joseph-turow","chris-jay-hoofnagle","users-dont-want","adolescent-wellbeing","digital-technology-use","355358-sample","screentime-depression","04-percent","flawed-research","patrick-markey","ai-context","labor-integration","data-society","alexandra-mateescu","madeleine-clare-elish","automated-technologies","family-farms","grocery-stores","human-infrastructures","machine-legible","mark-manson-quote"],"dg-note-properties":{"title":"Focusing on Importance","created":"2019-02-02","last_updated":"2025-12-13","status":"🌲_evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","defining-digital-literacy","workgroups","literacy-educators","grayscale-phones","peergrade","peer-review","student-feedback","marie-forleo","mark-manson","subtle-art","focusing-importance","nsfw-language","new-yorker","internet-retrospective","tech-moments","privacy-concerns","data-security","nostalgia-tech","facebook-vpn","teen-data-collection","project-atlas","13-to-35-users","20-dollar-payment","total-phone-access","apple-blocks-facebook","data-scandals","pattern-behavior","spying-users","selling-advertisers","obfuscation","transparency-blocks","zuckerberg-delusion","consumer-content","tailored-ads","ad-personalization","joseph-turow","chris-jay-hoofnagle","users-dont-want","adolescent-wellbeing","digital-technology-use","355358-sample","screentime-depression","04-percent","flawed-research","patrick-markey","ai-context","labor-integration","data-society","alexandra-mateescu","madeleine-clare-elish","automated-technologies","family-farms","grocery-stores","human-infrastructures","machine-legible","mark-manson-quote"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[Facebook Teen VPN Scandal\|Facebook Teen VPN Scandal]]","[[Zuckerberg Tailored Ads Delusion\|Zuckerberg Tailored Ads Delusion]]","[[Adolescent Wellbeing Screentime\|Adolescent Wellbeing Screentime]]","[[AI Labor Integration\|AI Labor Integration]]"],"shelf":"archived","description":"Issue 183 focusing on importance examines Facebook paying teens 13-35 $20 monthly for VPN access sucking up total phone data until Apple blocked it revealing systematic spying pattern, Zuckerberg's delusion that users want tailored ads when research shows they don't, massive study showing screentime explains less than 0.4% of adolescent depression exposing flawed previous research, and Data & Society report on human infrastructures needed to work with AI automation requiring making work machine-legible."}}
---
...
**Published**: 2019-02-02 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]
...
- [What is Digital Literacy?](https://wiobyrne.com/what-is-digital-literacy/) - I'm serving on two workgroups that are revising/rewriting the definitions of digital literacy for literacy educators. This post shares some insight...and asks for response.
- [What is Screentime?](https://screentime.me/grayscale/) - Change your phone's display to grayscale.
- [Encouraging & facilitating student peer review using Peergrade](https://www.youtube.com/watch?v=hTifSvEEF0o&t=3s) - An overview of Peergrade, a tool that I've been using to create a space to allow my students to give and get feedback from peers.
...
### [Mark Manson on Focusing on What Matters](https://www.youtube.com/)

Marie Forleo interviewing [Mark Manson](https://markmanson.net/) to identify the ways to focus on the things that matter in life. Manson is the author of the book, [*The Subtle Art of Not Giving a F*ck*](https://www.amazon.com/Subtle-Art-Not-Giving-Counterintuitive/dp/0062457713). I just finished reading this book, and it was excellent.
...
### [An Internet Retrospective](https://www.newyorker.com/)
...
### [Facebook Has Been Paying Teens $20 a Month for Total Access to Their Phone Activity](https://www.theverge.com/2019/1/29/18202880/facebook-research-enterprise-root-certificate-onavo-techcrunch)

Since 2016, Facebook has a program where they pay users from 13 to 35 up to **$20 a month** to install a VPN ([virtual private network](https://gizmodo.com/vpns-what-they-do-how-they-work-and-why-youre-dumb-f-5990192)) on their phones. They use this [backdoor to suck up all of the user's data](https://techcrunch.com/2019/01/29/facebook-project-atlas/) to study their habits and practices.

Hours after the story broke, Facebook indicated that it would shut down the program. But, before they did anything, [Apple blocked the app on iOS devices](https://techcrunch.com/2019/01/30/apple-bans-facebook-vpn/).

So why does this matter? Facebook is entering a second year of huge [data scandals](https://www.vox.com/policy-and-politics/2018/3/23/17151916/facebook-cambridge-analytica-trump-diagram). There is a pattern in which Facebook spies on users, collects data, and sells this off to advertisers...or worse. When they get caught, they obfuscate, [block transparency tools](https://www.propublica.org/article/facebook-blocks-ad-transparency-tools), or defer. **They cannot be trusted with our data.**
...
### [Mark Zuckerberg's Delusion of Consumer Content](https://www.nytimes.com/2019/01/29/opinion/zuckerberg-facebook-ads.html)
...
In this opinion, [Joseph Turow](https://www.asc.upenn.edu/people/faculty/joseph-turow-phd) and [Chris Jay Hoofnagle](https://www.law.berkeley.edu/our-faculty/faculty-profiles/chris-jay-hoofnagle/) share some research in which users suggest...**no**...this is not something that we want.
...
### [The Association Between Adolescent Well-Being and Digital Technology Use](https://www.amyorben.com/publication/2019_orbenprzybylski_nhb/)

A [new paper](https://www.amyorben.com/publication/2019_orbenprzybylski_nhb/) based on a massive sample size of **355,358 adolescents** indicates that **screentime explains less than 0.4% of depression**. The research also shows that previous research in this area is deeply flawed.

This [twitter thread by Patrick Markey](https://twitter.com/patmarkey/status/1084842687755362305) provides an excellent overview on the publication.
...
### [AI in Context: The Labor of Integrating New Technologies](https://datasociety.net/output/ai-in-context/)

In this new report from [Data & Society](https://datasociety.net/), researchers [Alexandra Mateescu](https://datasociety.net/people/mateescu-alexandra/) and [Madeleine Clare Elish](https://datasociety.net/people/elish-madeleine-clare/) show how automated and AI technologies are reconfiguring work at family-owned farms and grocery stores.
...
### [Performance and Printed Text](https://www.youtube.com/)
...
**Previous**: [[03 CREATE/33 Newsletter/TLDR 182\|TLDR 182]] • **Next**: [[03 CREATE/33 Newsletter/TLDR 184\|TLDR 184]] • **Archive**: [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

**🌱 Connected Concepts**:

- [[Facebook Teen VPN Scandal\|Facebook Teen VPN Scandal]] — Facebook paying users 13-35 $20 monthly for total phone surveillance through VPN until Apple blocked revealing systematic spying pattern in [[02 CURATE/Surveillance Capitalism\|Surveillance Capitalism]].
...
- [[Internet Nostalgia\|Internet Nostalgia]] — New Yorker retrospective on tech moments allowing appreciation for acceleration while maintaining critical eye on whether velocity prevented thoughtful development in [[Technology History\|Technology History]].
