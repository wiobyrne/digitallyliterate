---
{"dg-publish":true,"dg-permalink":"tldr-120","permalink":"/tldr-120/","title":"Too Long; Didn't Read Issue 120","tags":["digital-literacy","education-technology","pew-research","misinformation","information-futures","silicon-valley","platform-critique","tech-industry","screen-time","children","media-consumption","reading","print-vs-digital","learning-media","writing","creativity","google-docs","assessment","edtech-tools"],"dg-note-properties":{"title":"Too Long; Didn't Read Issue 120","created":"2017-10-21","last_updated":"2025-12-18","status":"🌲_evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","pew-research","misinformation","information-futures","silicon-valley","platform-critique","tech-industry","screen-time","children","media-consumption","reading","print-vs-digital","learning-media","writing","creativity","google-docs","assessment","edtech-tools"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[Information Futures\|Information Futures]]","[[Platform Critique\|Platform Critique]]","[[Children and Screens\|Children and Screens]]","[[Reading on Screens\|Reading on Screens]]","[[Digital Pedagogy Tools\|Digital Pedagogy Tools]]"],"shelf":"archived","description":"Issue 120 considers cost, value, and possibly changing the game. Topics include Jim Carrey speech on need for acceptance making you invisible, Pew research on future of truth and misinformation online, Silicon Valley tech companies not your friend, young children spending more time on small screens Common Sense Media, students learning better from books than screens debate, Anne Lamott's thirteen writing tips, and CheckMark extension for providing feedback on Google Docs."}}
---
...
**Published**: 2017-10-21 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]
...
- [Sincerity and truth in labeling of online information](http://wiobyrne.com/online-sincerity/) - This post some of thinking about critical evaluation and making sense of the sincerity of information you read online.
- Video: [How you should and could be reading online](https://www.youtube.com/watch?v=SZ_Px1wBcLY)
...
### [The NEED for acceptance will make you INVISIBLE - Jim Carrey](https://www.youtube.com/watch?v=cCDAiFrWNP0)

This animated short comes from the [After Skool YouTube channel](https://www.youtube.com/channel/UC1KmNKYC1l0stjctkGswl6g).

This voiceover was taken from [Jim Carrey's speech at the Maharishi University of Management in 2014](https://www.youtube.com/watch?v=V80-gPkpH6M).

---

## 📚 Read

### [The future of truth and misinformation online](http://www.pewinternet.org/2017/10/19/the-future-of-truth-and-misinformation-online/)
...
The results are somewhat split as to whether or not the coming decade will see a reduction in false and misleading narratives online. Review [the full report here](http://assets.pewresearch.org/wp-content/uploads/sites/14/2017/10/19095643/PI_2017.10.19_Future-of-Truth-and-Misinformation_FINAL.pdf).
...
This piece from [Noam Cohen](https://twitter.com/noamcohen) in the [Sunday Review from the NY Times](https://www.nytimes.com/section/opinion/sunday) crystalizes some of the thinking I've had over the past year about social networks and their use. Specifically, we're beginning to understand that these tech companies and platforms don't have our best interests at heart.
...
### [Young children are spending much more time in front of small screens](http://www.npr.org/sections/ed/2017/10/19/558178851/young-children-are-spending-much-more-time-in-front-of-small-screens)

This post from Anya Kamenetz on NPR Ed shares results from research report released this week from Common Sense Media. Review [the full report from Common Sense here](https://www.commonsensemedia.org/research/the-common-sense-census-media-use-by-kids-age-zero-to-eight-2017#).
...
### [Students learn better from books than screens, according to a new study](https://www.weforum.org/agenda/2017/10/students-learn-better-from-books-than-screens-according-to-a-new-study)

This week I shared out this research report on my socials and immediately kicked up a bunch of controversy among my online friends and colleagues. You can [review the post here on Facebook](https://www.facebook.com/wiobyrne/posts/10210331951752027?comment_id=10210345498370684&reply_comment_id=10210348195798118&notif_id=1508378595986042&notif_t=feed_comment) and review the comments.
...
I agree with the results from Alexander and Singer, but think that the truth is far murkier. Part of my response is in [the video I linked above](https://www.youtube.com/watch?v=SZ_Px1wBcLY). I think there are ways that we (and our students) should and could be reading on screens. Merely moving print to a screen does not take into account complexities of new tools and practices.

On a side note, I'm looking at different places to publish to reach different audiences. I'm paying attention to how Alexander and Singer published their original research, and then published a version of the findings in [The Conversation](https://theconversation.com/us) and this was in conjunction with the [World Economic Forum](https://www.weforum.org/). Finally...this was picked up by [Business Insider](http://www.businessinsider.com/students-learning-education-print-textbooks-screens-study-2017-10?IR=T). For those of you that regularly write and blog...this is something to pay attention to.

---

### [13 writing tips, from beloved teacher Anne Lamott](https://ideas.ted.com/14-writing-tips-from-beloved-teacher-anne-lamott/)

[Anne Lamott](https://twitter.com/ANNELAMOTT), the presenter of the TED Talk [12 truths I learned from life and writing](https://www.ted.com/talks/anne_lamott_12_truths_i_learned_from_life_and_writing), shares advice on writing:
...
### [CheckMark Extension for providing feedback on Google Docs](http://www.freetech4teachers.com/2017/10/checkmark-extension-for-providing.html#.WesnThNSyHo)
...
The [CheckMark](http://www.checkmarkclass.com/) [Chrome extension](https://chrome.google.com/webstore/detail/checkmark/kfddponboekcbjlhhjinkefjollhhidp) allows you save frequent comments in an overlay and quickly click/add while reviewing. The selections show up as comments on the student work. See a [video of it in action here](http://www.checkmarkclass.com/demo.html).
