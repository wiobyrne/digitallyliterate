---
{"dg-publish":true,"dg-permalink":"tldr-71","permalink":"/tldr-71/","title":"Too Long; Didn't Read Issue 71","tags":["digital-literacy","education-technology","us-election","polarization","filter-bubble","listening","resilience","educate-empower-advocate","cross-cultural-dialogue"],"dg-note-properties":{"title":"Too Long; Didn't Read Issue 71","created":"2016-11-12","last_updated":"2025-12-17","status":"🌲_evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","us-election","polarization","filter-bubble","listening","resilience","educate-empower-advocate","cross-cultural-dialogue"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[School of Life\|School of Life]]","[[US Election 2016\|US Election 2016]]","[[Polarization\|Polarization]]","[[Filter Bubble\|Filter Bubble]]","[[Listening\|Listening]]","[[Kate Bowles\|Kate Bowles]]","[[Eli Pariser\|Eli Pariser]]","[[Four Questions For Podcast\|Four Questions For Podcast]]"],"shelf":"archived","description":"Issue 71 - lessons from US election. School of Life resilience in hard times you have decision to make, Trump future of education unclear I hope administration rises to occasion, hyper-polarization intensity gap I think education is key, filter bubble technology hijacking minds spoon-fed psychological vulnerabilities, Kate Bowles on listening this result is in our terrain, and cross-cultural dialogue builds critical thinking make exotic familiar."}}
---
...
**Published**: 2016-11-12 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]
...
You can also follow along on [Instagram](https://www.instagram.com/wiobyrne/) and [Snapchat](https://www.snapchat.com/add/wiobyrne). I'm continuing to play with Instagram and Facebook Live as part of this work...and testing some things I'm learning from this week's issue.

This week I worked on the following:

- [Four Questions For (4Q4) podcast](http://wiobyrne.com/4q4/) - I'm rebooting my podcast series on education, technology, and literacy. You can subscribe on [Soundcloud](https://soundcloud.com/4q4podcast), [iTunes](https://itunes.apple.com/us/podcast/four-questions-for-podcast/id1118019240), [Google Play Music](https://goo.gl/app/playmusic?ibi=com.google.PlayMusic&isi=691797987&ius=googleplaymusic&link=https://play.google.com/music/m/Iatnkr5kyn4awlgjz2v3vz6jaxe?t%3DFour_Questions_For_podcast), or your [favorite podcast client](http://feeds.feedburner.com/4q4Podcast).
- [Control your controllables](http://wiobyrne.com/imho/2016/control-your-controllables) - My Wife deserves all of the credit for this statement. She repeatedly would state it to colleagues, and when I would discuss work issues with her. I took some time to think through what this might mean...and weave in some Stoic philosophy.
...
### [Resilience in hard times](https://www.youtube.com/watch?v=9vdN15--hro)

A thoughtful video from the [School of Life YouTube](https://www.youtube.com/channel/UC7IcJI8PUf5Z3zKxnZvTBog) channel this week. This video serves as a good reset button for each of us as we move forward. Suffering, challenge, and choice are present in each day of our lives.
...
### [Donald Trump and the future of education](http://www.theatlantic.com/education/archive/2016/11/donald-trump-on-education/507167/)

There is no other way to start this week's issue that with this post. This post from [Emily DeRuy](https://twitter.com/Emily_DeRuy) in [The Atlantic](http://www.theatlantic.com/) discusses the future of education under a Trump presidency.

As Emily notes, much of this is very unclear. We really have no way of knowing what direction a Trump leadership will head as he vacillated between multiple perspectives and platforms throughout the election cycle. I do hope that his administration will rise to the occasion as I believe education is one of the key ways to break ourselves of this cycle.

---

### [The hyper-polarization of America](https://blogs.scientificamerican.com/guest-blog/the-hyper-polarization-of-america/)

Post from [Alexander George Theodoris](https://sites.google.com/site/alexandertheodoridis/), an Assistant Professor of Political Science at the University of California, Merced. In this piece, Alexander details what he identifies as the "Intensity Gap" in which we (Americans) are less and less likely to be able to understand or empathize with each other.
...
This week I think we also saw the effects of the "filter bubble" rear its ugly head. Yes, there are [major divisions across race, gender, and education](http://www.pewresearch.org/fact-tank/2016/11/09/behind-trumps-victory-divisions-by-race-gender-education/). Yes, we need to really examine the role of education and higher ed specifically. We also cannot discount how [big data failed us](http://mobile.nytimes.com/2016/11/10/technology/the-data-said-clinton-would-win-why-you-shouldnt-have-believed-it.html?referer=), and the increasing [challenges of global hackers](https://www.wired.com/2016/11/trumps-win-signals-open-season-russias-political-hackers/). Given all of these challenges, as we grow increasingly polarized, we need to consider what options our digital texts are providing us.

The [filter bubble](https://en.wikipedia.org/wiki/Filter_bubble) was coined by Eli Pariser and details how our internet searches, or content displayed in our social networks & newsfeeds may be customized to only show us what we want to see. This is all determined by algorithms and many times you don't know that it is even happening. In plain english, Facebook (and others) are showing you what you want to see.
...
After this week's election results, Facebook and Twitter indicate that they are "[grappling with their role as news filters](https://www.bloomberg.com/news/articles/2016-11-09/facebook-and-twitter-contend-with-their-role-in-trump-s-victory)." Facebook admitted that it must do more to [stop possible misinformation on its platform](https://techcrunch.com/2016/11/10/facebook-admits-it-must-do-more-to-stop-the-spread-of-misinformation-on-its-platform/), even though [you may not have even seen it](http://nymag.com/scienceofus/2016/11/how-facebook-and-the-filter-bubble-pushed-trump-to-victory.html).

One thing that you can do to avoid this in the short-term is to possibly follow people outside of your beliefs and perspectives on social networks. I'd also recommend bookmarking [Mediagazer](http://www.mediagazer.com/) and reading it as you consume political news. It takes news streams from everywhere and pulls it into one "text" for you to consume. It's not perfect...but it's a start.

---

### [What do we tell the children?](http://www.huffingtonpost.com/entry/what-should-we-tell-the-children_us_5822aa90e4b0334571e0a30b)
...
### [Listening](http://musicfordeckchairs.com/blog/2016/11/10/listening-2/)

Post from [Kate Bowles](https://twitter.com/KateMfD) documenting the subtle art and elegance of "listening." In this "case study" she recounts and reflects on the roles and outcomes for educators in higher ed.
...
### [How cross-cultural dialogue builds critical thinking and empathy](http://ww2.kqed.org/mindshift/2016/11/10/how-cross-cultural-dialogue-builds-critical-thinking-and-empathy/)
...
[Katrina Schwartz](https://twitter.com/kschwart) details a series of initiatives designed for students and educators to "make the exotic familiar." In this we have the opportunity to help students develop positive habits around interactions online.
...
**Previous**: [[03 CREATE/33 Newsletter/TLDR 70\|TLDR 70]] • **Next**: [[03 CREATE/33 Newsletter/TLDR 72\|TLDR 72]] • **Archive**: [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

**🌱 Connected Concepts**:

- **[[School of Life\|School of Life]]** — Resilience in hard times video reset button, suffering challenge choice you have decision to make each day anew.
- **[[US Election 2016\|US Election 2016]]** — Trump future of education unclear, I hope administration rises to occasion education key way to break cycle.
- **[[Polarization\|Polarization]]** — Hyper-polarization intensity gap less likely to understand empathize, identify strongly with party bias interpreting information.
- **[[Filter Bubble\|Filter Bubble]]** — Eli Pariser coined term showing you what you want to see, we're being spoon-fed hijacking psychological vulnerabilities.
- **[[Listening\|Listening]]** — Kate Bowles on subtle art and elegance, this result is in our terrain without human listening no business in education.
- **[[Kate Bowles\|Kate Bowles]]** — Educators woken up to work, computational analysis can't do as well naive faith in data outsourced capacity to think.
- **[[Eli Pariser\|Eli Pariser]]** — Filter bubble internet searches newsfeeds customized to only show what you want, determined by algorithms don't know happening.
- **[[Four Questions For Podcast\|Four Questions For Podcast]]** — Rebooting podcast series education technology literacy, subscribe on Soundcloud iTunes Google Play Music.
