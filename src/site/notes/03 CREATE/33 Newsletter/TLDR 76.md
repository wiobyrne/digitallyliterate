---
{"dg-publish":true,"dg-permalink":"tldr-76","permalink":"/tldr-76/","title":"Too Long; Didn't Read Issue 76","tags":["digital-literacy","education-technology","intervening-in-situations","critical-literacy","fake-news","online-privacy","yahoo-hack","bias-attacks","hypothesis","photography"],"dg-note-properties":{"title":"Too Long; Didn't Read Issue 76","created":"2016-12-16","last_updated":"2025-12-18","status":"🌲_evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","intervening-in-situations","critical-literacy","fake-news","online-privacy","yahoo-hack","bias-attacks","hypothesis","photography"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[Critical Literacy\|Critical Literacy]]","[[Fake News\|Fake News]]","[[Online Privacy\|Online Privacy]]","[[Yahoo Hack\|Yahoo Hack]]","[[Bias Attacks\|Bias Attacks]]","[[Hypothesis\|Hypothesis]]","[[National Education Technology Plan\|National Education Technology Plan]]","[[Kylene Beers\|Kylene Beers]]","[[Night Photography\|Night Photography]]"],"shelf":"archived","description":"Issue 76 - intervening in situations. Wired Argument Clinic proof lies on he who asserts I still think facts louder than opinion, teachers disrupt fake news Heinemann Publishing critical literacy, National Education Technology Plan I'm still digesting, Yahoo hacked again I'm in process of changing my note taking system, should you intervene in bias attack I think WHEN not IF, Hypothesis one of my favorite tools I'll be spending a lot more time, and taking pictures of sky at night I've been spending more time with cameras."}}
---
...
**Published**: 2016-12-16 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]
...
This week I spent time closing out grades for the semester and revising a [chapter on how to be a digitally agile researcher](https://docs.google.com/document/d/1J1cZOIhlPDlyr-iVPhDcopLDTIUw0CraBdumulWvr0k/edit?usp=sharing). I also published [this post](http://wiobyrne.com/imho/2016/slow-is-smooth-smooth-is-fast) about focusing on the granular elements when learning something new.
...
### [How to fight the bad logic of the internet](https://www.youtube.com/watch?v=1iN5Kkz5dEw)

This video is from [a new video series from Wired called "Argument Clinic."](https://www.wired.com/2016/12/want-fight-online-bs-weve-got-crash-course/)

In this video they indicate elements from the [presumption of innocence](https://en.wikipedia.org/wiki/Presumption_of_innocence) to indicate that: Proof lies on he who asserts, not he who denies.
...
### [How teachers can disrupt fake news](https://medium.com/@heinemann/how-to-repudiate-fake-news-through-critical-literacy-instruction-87d09bd34ec6#.o11svlm4i)
...
The post shares a series of three big questions [originally shared by Kylene Beers and Bob Probst](http://www.heinemann.com/products/E05080.aspx):
...
### [The National Education Technology Plan](http://tech.ed.gov/netp/)
...
I'm still in the process of digesting this plan. The website does a good job of breaking down the report into specific sections. To access [the full report (PDF) click here](http://tech.ed.gov/files/2015/12/NETP16.pdf).

---

### [Eight things you need to do right now to protect yourself online](https://www.theguardian.com/technology/2016/dec/15/protect-passwords-two-step-verification-encryption-digital-life-privacy)

If you haven't seen it already, [Yahoo was hacked (again)](https://bgr.com/2016/12/15/yahoo-mail-security-breach/). This is the second time in six months that they disclosed breaches of your data. The key thing to remember is that they knew about these hacks years ago. They only now are sharing this with the public.

In a related note, Evernote changed their terms of service and are [building in opportunities for their employees to read your content](https://lifehacker.com/evernote-employees-can-read-your-notes-and-theres-no-w-1790099958) (if needed). I'm in the process of changing my note taking system over to something new.
...
### [Should you intervene in a bias attack?](https://www.scientificamerican.com/article/should-you-intervene-in-a-bias-attack/)
...
### [Hypothesis introduces updated search and profiles](https://hypothes.is/blog/introducing-search-and-profiles/)

One of my favorite tools to use in classes to have students read and collaborate. Imagine having students collaboratively read, annotate, and discuss using text on a website as opposed to each person reading on their own. [Hypothesis](https://hypothes.is/) allows you to collaboratively create an annotated layer on the internet.

You can read more about [how I use Hypothesis here](http://wiobyrne.com/using-hypothes-is/).
...
**Previous**: [[03 CREATE/33 Newsletter/TLDR 75\|TLDR 75]] • **Next**: [[03 CREATE/33 Newsletter/TLDR 77\|TLDR 77]] • **Archive**: [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

**🌱 Connected Concepts**:

- **[[Critical Literacy\|Critical Literacy]]** — Heinemann Publishing teachers disrupt fake news, students' ability to read critically is essential for them to write critically.
- **[[Fake News\|Fake News]]** — How teachers can disrupt through critical literacy instruction, Kylene Beers Bob Probst three big questions what surprised me.
- **[[Online Privacy\|Online Privacy]]** — Eight things you need to do right now to protect yourself, we need to be more vigilant about our own privacy and security.
- **[[Yahoo Hack\|Yahoo Hack]]** — Second time in six months they disclosed breaches of your data, they knew about hacks years ago only now sharing with public.
- **[[Bias Attacks\|Bias Attacks]]** — Should you intervene Scientific American complex calculus, I think the first step being aware WHEN not IF they will happen act not freeze.
- **[[Hypothesis\|Hypothesis]]** — One of my favorite tools students read collaborate annotate, I'm most excited by improvements to profiles I'll be spending a lot more time.
- **[[National Education Technology Plan\|National Education Technology Plan]]** — 2016 Future Ready Learning equity active use collaborative leadership, I'm still in process of digesting this plan.
- **[[Kylene Beers\|Kylene Beers]]** — Three big questions with Bob Probst what surprised me, what did author think I already knew what changed challenged confirmed.
- **[[Night Photography\|Night Photography]]** — I've been spending more time with cameras one challenge taking photos of sky, Lifehacker post right equipment environment settings aperture shutter ISO.
