---
{"dg-publish":true,"dg-permalink":"tldr-101","permalink":"/tldr-101/","title":"Too Long; Didn't Read Issue 101","tags":["digital-literacy","education-technology","automation","future-of-work","tech-philanthropy","silicon-valley","information-manipulation","encryption","hate-speech","digital-citizenship","internet-safety"],"dg-note-properties":{"title":"Too Long; Didn't Read Issue 101","created":"2017-06-09","last_updated":"2025-12-18","status":"🌲_evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","automation","future-of-work","tech-philanthropy","silicon-valley","information-manipulation","encryption","hate-speech","digital-citizenship","internet-safety"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[Tech Philanthropy\|Tech Philanthropy]]","[[Encryption and Privacy\|Encryption and Privacy]]","[[Information Manipulation\|Information Manipulation]]","[[Hate Speech in Education\|Hate Speech in Education]]","[[02 CURATE/Digital Citizenship\|Digital Citizenship]]"],"shelf":"archived","description":"Examining automation's impact on work, tech billionaire philanthropy in education, information manipulation, encryption debates, and hate speech in schools."}}
---
...
**Published**: 2017-06-09 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]
...
This week I shared:
- [Three things I've learned by writing a newsletter](http://wiobyrne.com/writing-a-newsletter/) - This post is primarily a reflection of things I've learned about the process of writing this newsletter. I think it's helpful for those of you that have already started a newsletter, and you're looking for reasons to keep going.
- [Prompts & Reflections from TXEDUCHAT](http://wiobyrne.com/txeduchat-6-4-2017/) - This past week I hosted the TXEDUCHAT. The focus of this chat was on becoming a digitally agile educator. This is a very important topic for me that frames much of my work.
- [What is missing from the Mozilla Web Literacy Standards](http://wiobyrne.com/what-is-missing-from-web-literacy-standards/) - With the discussions about the Mozilla Network 50 selection (and some other recent events), I've been looking at opportunities to dive back into the web literacy work. This post outlines where I think this work should head...and my potential interests for these next steps.
...
This is another great video from the [Kurzgesagt - In a nutshell YouTube channel](https://www.youtube.com/channel/UCsXVk37bltHxD1rDPwtNM8Q). I love their work, and this video is very timely as it effectively discusses the role of automation in the future of jobs...and what makes it different at this point in time.
...
### [The Silicon Valley billionaires remaking America's schools](https://www.nytimes.com/2017/06/06/technology/tech-billionaires-education-zuckerberg-facebook-hastings.html?_r=0)

This piece in the [NY Times](http://www.nytimes.com/) by [Natasha Singer](https://twitter.com/natashanyt) documents some of the big philanthropic money being spent by Silicon Valley executives.
...
This piece from [Roger Sollenberger](https://twitter.com/rlongennamer) in [Paste Magazine](https://www.pastemagazine.com/) talks about the money and lack of transparency that is affecting the information that you read online.
...
### [Theresa May wants to ban crypto: Here's what that would cost, and here's why it won't work anyway](https://boingboing.net/2017/06/04/theresa-may-king-canute.html)
...
In this post from [Cory Doctorow](https://twitter.com/doctorow) in [Boing Boing](https://boingboing.net/) you can review a thorough explanation of how and why weakening/banning encryption is a horrible idea.
...
### [The Kids are Alt-Right](https://www.buzzfeed.com/albertsamaha/kids-are-quoting-trump-to-bully-their-classmates?utm_term=.ifk8888bg7#.ub8zzzz1VB)
...
This post from [BuzzFeed](https://www.buzzfeed.com/) shares some insight into recent acts of hate speech, vandalism in U.S. schools following the U.S. Presidential election.
...
This post by [Josh Sokol](https://twitter.com/josh_sokol) in [Quanta Magazine](https://www.quantamagazine.org/) is the perfect cleanse for your brain after reading too much about politics, technology, or education. This piece from Sokol examines some of the ways in which different organisms may store cognitive information in the physical world.
...
### [Google developed a school curriculum to help kids fight trolls and hackers](https://www.theverge.com/2017/6/6/15739412/google-be-internet-awesome-interland-hacking-phishing-troll-curriculum)
...
Called "[Be Internet Awesome](https://blog.google/topics/families/be-internet-awesome-helping-kids-make-smart-decisions-online/)," it includes a classroom curriculum and a video game called [Interland](https://beinternetawesome.withgoogle.com/interland). It was developed with help from teachers, YouTube videographers, and internet safety and literacy organizations, and resources are available online for free.

You can learn more from Richard Byrne's [post on the topic](http://www.freetech4teachers.com/2017/06/be-internet-awesome-googles-new.html).
...
**Previous**: [[03 CREATE/33 Newsletter/TLDR 100\|TLDR 100]] • **Next**: [[03 CREATE/33 Newsletter/TLDR 102\|TLDR 102]] • **Archive**: [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

**🌱 Connected Concepts**:

- [[Tech Philanthropy\|Tech Philanthropy]] — Silicon Valley billionaires like Zuckerberg and Hastings are remaking American schools with little public scrutiny, raising concerns about the democratizing process and lack of transparency in how philanthropic money shapes education policy and practice.
...
- [[02 CURATE/Digital Citizenship\|Digital Citizenship]] — Google's "Be Internet Awesome" curriculum and Interland game teach kids about phishing, harassment, and passwords, developed with teachers and internet safety organizations to provide free resources for building digital literacy skills from an early age.
