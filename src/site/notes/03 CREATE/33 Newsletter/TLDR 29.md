---
{"dg-publish":true,"dg-permalink":"tldr-29","permalink":"/tldr-29/","title":"Too Long; Didn't Read Issue 29","tags":["digital-literacy","education-technology","walkmyworld","twitter","steven-johnson","innovation","penn-teller","teaching","false-expertise","growth-mindset","carol-dweck","disconnection","creativity","magnetic-poetry"],"dg-note-properties":{"title":"Too Long; Didn't Read Issue 29","created":"2016-01-22","last_updated":"2025-12-16","status":"🌲_evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","walkmyworld","twitter","steven-johnson","innovation","penn-teller","teaching","false-expertise","growth-mindset","carol-dweck","disconnection","creativity","magnetic-poetry"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[WalkMyWorld Project\|WalkMyWorld Project]]","[[Twitter]]","[[Steven Johnson\|Steven Johnson]]","[[Growth Mindset\|Growth Mindset]]","[[Creativity]]"],"shelf":"archived","description":"WalkMyWorld Project 2016 launch come make and share with us for next 10 learning events, educational uses of Twitter guide for embedding in classroom and own literacy practices, Steven Johnson where good ideas come from time and intellectual space needed for innovation, Penn teaching like performing magic first job of teacher is to make student fall in love with subject you are symbol, false expertise if you think you're an expert you might want to keep studying double-check your facts feel free to get second-opinion, growth mindset in teachers and staff Most of this work indicates need to build but does not explicitly state how Furthermore guidance usually about students as opposed to teachers and staff, disconnect to innovate Perhaps it is these spaces of time spent being mindful or disconnected that allow us to truly be creative, Twitter guide I often have complaints from colleagues there is certain amount of work you need to conduct to get Twitter running for you, and magnetic pixel poetry thinking about putting these on my door at work."}}
---
...
**Published**: 2016-01-22 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]
...
- [Welcome to the WalkMyWorld Project 2016](http://wiobyrne.com/welcome-to-the-walkmyworld-project-2016/) - This week we launched the [pre-learning event](http://walkmy.world/start-walking/walk2016/le0/) for WalkMyWorld 2016. The project is an open learning experience in which learners create, share, and connect online. Come make and share with us for the next 10 learning events.
- [Educational uses of Twitter in teaching, learning, and socializing](https://medium.com/@wiobyrne/educational-use-of-twitter-in-teaching-learning-and-socializing-8013078afc27#.hq9v5m2ih) - This post is a guide for individuals as they identify ways to embed Twitter into their classroom...and own literacy practices.
...
### [WHERE GOOD IDEAS COME FROM by Steven Johnson](https://www.youtube.com/watch?v=NugRZGDbPFU)
...
### [Teaching: Just like performing magic](http://www.theatlantic.com/education/archive/2016/01/what-classrooms-can-learn-from-magic/425100/)
...
### [You don't know as much as you think: False expertise](http://www.scientificamerican.com/article/you-don-t-know-as-much-as-you-think-false-expertise/)
...
The post is guided by [research from Psychological Science](http://pss.sagepub.com/content/early/2015/07/14/0956797615588195.abstract) that examines perceived as opposed to actual knowledge from content areas that people identify as an expertise. The takeaways indicate that if you think you're an expert in an area...you might want to keep studying and double-check your facts. If you're consulting with an "expert"...feel free to get a second-opinion.
...
### [From problem solver to innovator: Is the answer to disconnect?](http://blogs.edweek.org/edweek/leadership_360/2016/01/from_problem_solver_to_innovator_is_the_answer_to_disconnect.html)
...
### [Twitter guide: How to do everything with Twitter](http://www.labnol.org/internet/twitter-guide-do-everything-with-twitter/4916/)

A great guide from [Amit Agarwal](https://twitter.com/labnol) looking at tools to make your life a bit more productive as you try to reach out and use Twitter.
...
### [Magnetic Pixel Poetry](http://www.instructables.com/id/Magnetic-Pixel-Poetry/)

Very cool make from [Instructables](http://www.instructables.com/) member [depotdevoid](http://www.instructables.com/member/depotdevoid/).
...
**Previous**: [[03 CREATE/33 Newsletter/TLDR 28\|TLDR 28]] • **Next**: [[03 CREATE/33 Newsletter/TLDR 30\|TLDR 30]] • **Archive**: [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

**🌱 Connected Concepts**:

- **[[WalkMyWorld Project\|WalkMyWorld Project]]** — 2016 launch, open learning experience, come make and share for next 10 learning events.
- **[[Twitter Education\|Twitter Education]]** — Guide for embedding Twitter into classroom and own literacy practices.
- **[[Twitter Complaints\|Twitter Complaints]]** — I often have complaints from colleagues, certain amount of work you need to conduct.
- **[[Steven Johnson\|Steven Johnson]]** — Where good ideas come from, time and intellectual space needed for innovation.
- **[[Penn & Teller\|Penn & Teller]]** — Teaching like performing magic, performance and discomfort make education come alive.
- **[[Teacher as Symbol\|Teacher as Symbol]]** — First job is to make student fall in love with subject, you are symbol in students' minds.
- **[[False Expertise\|False Expertise]]** — If you think you're an expert keep studying double-check facts, consulting expert feel free get second-opinion.
- **[[Psychological Science\|Psychological Science]]** — Research examining perceived as opposed to actual knowledge from content areas.
- **[[Growth Mindset\|Growth Mindset]]** — In teachers and staff, work indicates need but does not explicitly state how.
- **[[Carol Dweck\|Carol Dweck]]** — Work on growth mindsets, modeling creating new spaces self-reflection formative feedback.
- **[[Jackie Gerstein\|Jackie Gerstein]]** — Growth mindset guidance for teachers and staff, not just students.
- **[[Disconnect to Innovate\|Disconnect to Innovate]]** — Constant connection does not provide time or space for downtime or self-reflection.
- **[[Mindful Disconnection\|Mindful Disconnection]]** — Perhaps spaces of time spent being mindful or disconnected allow us to truly be creative and innovative.
- **[[Twitter Guide\|Twitter Guide]]** — Amit Agarwal tools to make life more productive, expand use of tool.
- **[[Magnetic Pixel Poetry\|Magnetic Pixel Poetry]]** — Pixelated art version of magnetic poetry sets, thinking about putting on my door at work.
- **[[Charles Bukowski\|Charles Bukowski]]** — Unless it comes unasked out of your heart and mind and mouth and gut, don't do it.
