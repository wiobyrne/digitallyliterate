---
{"dg-publish":true,"dg-permalink":"tldr-134","permalink":"/tldr-134/","title":"Too Long; Didn't Read Issue 134","tags":["digital-literacy","education-technology","being-an-ally","chescaleigh","privilege","safe-zone-training","deepfakes","ai-generated-porn","machine-learning","revenge-porn","fake-news","social-media-addiction","tech-executives","screen-time","digital-detox","middlebury","dlinq","racism-in-schools","sonja-cherry-paul","net-neutrality","burger-king","ajit-pai","kaizena","voice-comments","google-docs"],"dg-note-properties":{"title":"Too Long; Didn't Read Issue 134","created":"2018-01-26","last_updated":"2025-12-19","status":"🌲_evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","being-an-ally","chescaleigh","privilege","safe-zone-training","deepfakes","ai-generated-porn","machine-learning","revenge-porn","fake-news","social-media-addiction","tech-executives","screen-time","digital-detox","middlebury","dlinq","racism-in-schools","sonja-cherry-paul","net-neutrality","burger-king","ajit-pai","kaizena","voice-comments","google-docs"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[Being an Ally\|Being an Ally]]","[[AI Deepfakes Danger\|AI Deepfakes Danger]]","[[Tech Executives Don't Use Products\|Tech Executives Don't Use Products]]","[[Digital Detox Movement\|Digital Detox Movement]]","[[Addressing Racism in Schools\|Addressing Racism in Schools]]","[[Net Neutrality Explanation\|Net Neutrality Explanation]]"],"shelf":"archived","description":"Issue 134 friend or foe poison or detox explores Chescaleigh's five tips for being an ally unpacking privilege and expectations, AI-generated deepfakes app creating fake porn raising revenge porn and propaganda concerns with machine learning synthesizing facial expressions, tech executives designing addictive platforms but not allowing their own kids to use same products revealing never get high on own supply mentality, Middlebury DLINQ Digital Detox 2018 initiative reducing toxicity of personal digital environments through critical habits, Sonja Cherry-Paul's five steps for shattering silence about race in schools from Hechinger Report, and Burger King's brilliant net neutrality video roasting Ajit Pai with best explanation through Whopper analogy."}}
---
...
**Published**: 2018-01-26 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

Welcome to Issue 134. Friend or foe, poison or detox.

As a reminder, last week we rebooted the [Digitally Literate Research Project](http://digitallyliterate.net/). This is an open research project in which we're studying the use of technology in instruction around the globe. Our survey is in English and available [here](http://digitallyliterate.net/tltsurvey/). If you're an educator in Pre-K up through higher ed...especially in international audiences...please take/share this.

This week I posted the following:
- [Take the time to review & reinforce your digital hygiene](http://wiobyrne.com/digital-hygiene/) - This post is the synthesis of my earlier series of posts on ensuring your privacy and security online.
- [Where I'm from](https://medium.com/rps-2k18/where-im-from-8240c3c48575) - As part of my slam poetry class, students spent this week writing about where they're from and will post to our [Medium pub](https://medium.com/rps-2k18). In these activities, I'm remixing some of the learning events from our previous work with the [Walk My World project](http://walkmy.world/).
- [Challenges in localization of research](http://digitallyliterate.net/localization-of-research/) - This post is a researcher note from our work on the Digitally Literate Research Project.
- Video: [Two ways to use Hypothesis for reading, research, & response](https://www.youtube.com/watch?v=CTYSxfvcong)
- Video: [Theoretical perspectives & contexts of language development](https://www.youtube.com/watch?v=BEt3w7-O7lY&t=1s)
...
### [We are truly f****d: Everyone is making AI-generated fake porn now](https://motherboard.vice.com/en_us/article/bjye8a/reddit-fake-porn-app-daisy-ridley)

Please be advised this story contains content that is NSFW. In short, it talks about PORN.

This story in [Motherboard](https://motherboard.vice.com/en_us) talks about an app that allows you to superimpose someone's face onto another person's body. For now, this app is being used to superimpose celebrity faces onto the bodies of porn performers.
...
You can click through the article to find the app, associated subreddit community, and more examples of this work. This work is still very new, and is becoming more sophisticated. It raises questions about the impact of this on ["revenge porn" or very real "fake news" and propaganda](https://www.bustle.com/p/a-fake-porn-app-lets-people-put-celebrities-faces-in-videos-heres-why-its-so-dangerous-8011788).

---

### ["Never get high on your own supply" - why social media bosses don't use social media](https://www.theguardian.com/media/2018/jan/23/never-get-high-on-your-own-supply-why-social-media-bosses-dont-use-social-media?CMP=Share_iOSApp_Other)
...
This piece by [Alex Hern](https://twitter.com/alexhern) in The Guardian looks at addiction, these digital products, and the reticence of their executives to actually use the platforms.
...
### [Digital Learning & Inquiry (DLINQ) Digital Detox 2018](http://dlinq.middcreate.net/digitaldetox/)
...
### [It's time to shatter the silence about race](http://hechingerreport.org/teacher-voice-time-shatter-silence-race/)

This piece in The Hechinger Report by [Sonja Cherry-Paul](https://litlearnact.wordpress.com/sonja-cherry-paul/) originally appeared in the January/February 2018 issue of [Literacy Today](https://www.literacyworldwide.org/get-resources/em-literacy-today-em-magazine), the member magazine of the [International Literacy Association](https://www.literacyworldwide.org/).
...
### [Even Burger King is roasting Ajit Pai over net neutrality repeal](https://gizmodo.com/even-burger-king-is-roasting-ajit-pai-over-net-neutrali-1822380669#ampshare=https://gizmodo.com/even-burger-king-is-roasting-ajit-pai-over-net-neutrali-1822380669)
...
Most Americans [support](https://blog.mozilla.org/blog/2017/06/06/new-mozilla-poll-americans-political-parties-overwhelmingly-support-net-neutrality/) net neutrality because most understand that it's not a good idea to allow Internet service providers to pick and choose the content they might want to block or throttle. And if they don't understand it at first, they tend to do so once they get a little information.

Once again, this issue of net neutrality is a hard one to understand. [This video](https://www.youtube.com/watch?time_continue=3&v=ltzy5vRmN8Q), from Burger King, a global chain of hamburger fast food restaurants is most likely the best explanation of net neutrality that I've seen.

---

## 🔨 Do

### [How to add voice comments to Google Docs](http://www.freetech4teachers.com/2018/01/how-to-add-voice-comments-to-google-docs.html#.Wms-3ZM-fUI)

[Kaizena](https://chrome.google.com/webstore/detail/kaizena/kfcmpbkmmdlcnepmeojihblcllopielg?hl=en) is a free add-on for Google Docs that makes it easy to add comments to your materials. In a recent update to the tool, they streamlined the ability to add voice notes so you don't have to leave your document. This is a good way to leave verbal feedback, or a think aloud to your work, or student work. Check out [this overview from Richard Byrne](http://www.freetech4teachers.com/2018/01/kaizena-streamlined-voice-commenting-in.html#.WmtGXpM-fUI) to learn more.
...
**Previous**: [[03 CREATE/33 Newsletter/TLDR 133\|TLDR 133]] • **Next**: [[03 CREATE/33 Newsletter/TLDR 135\|TLDR 135]] • **Archive**: [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

**🌱 Connected Concepts**:

- [[Being an Ally\|Being an Ally]] — Chescaleigh's video provides essential overview of allyship after Safe Zone training on campus revealed need to identify exactly what ally means and expectations of role—being ally requires more than good intentions, demanding ongoing education about privilege and commitment to advocating for marginalized communities without centering yourself, taking time to educate yourself rather than expecting marginalized people to teach you.
- [[AI Deepfakes Danger\|AI Deepfakes Danger]] — Motherboard reports on NSFW app allowing superimposing someone's face onto another person's body, currently used for celebrity faces on porn performers' bodies through machine learning and AI able to synthesize anyone's facial expressions and gestures from video clips—face-swapped videos convincing enough despite not looking 100% real, with Carrie Fisher CGI costing $200 million versus free app version, raising urgent questions about revenge porn and very real fake news propaganda as technology becomes more sophisticated.
