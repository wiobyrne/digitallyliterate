---
{"dg-publish":true,"dg-permalink":"tldr-165","permalink":"/tldr-165/","title":"Too Long; Didn't Read Issue 165","tags":["digital-literacy","education-technology","oprah-winfrey","touch","eye-contact","empathy","nonverbal-communication","emily-hanford","reading-science","phonics","teaching-reading","reading-instruction","science-of-reading","jeff-bezos","amazon-preschools","child-as-customer","ed-tech-criticism","audrey-watters","education-reform","billionaire-philanthropy","kids-apps","data-privacy","child-data-collection","surveillance-capitalism","google","twitter","teens","public-speaking","classroom-presentations","student-anxiety","mental-health","sean-michael-morris","jesse-stommel","critical-pedagogy","digital-pedagogy","urgency-of-teachers","equity-unbound","maha-bali","catherine-cronin","mia-zamora","moocs","open-learning","frederick-douglass","hurricane-florence","todd-finley"],"dg-note-properties":{"title":"Too Long; Didn't Read Issue 165","created":"2018-09-14","last_updated":"2025-12-13","status":"🌲_evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","oprah-winfrey","touch","eye-contact","empathy","nonverbal-communication","emily-hanford","reading-science","phonics","teaching-reading","reading-instruction","science-of-reading","jeff-bezos","amazon-preschools","child-as-customer","ed-tech-criticism","audrey-watters","education-reform","billionaire-philanthropy","kids-apps","data-privacy","child-data-collection","surveillance-capitalism","google","twitter","teens","public-speaking","classroom-presentations","student-anxiety","mental-health","sean-michael-morris","jesse-stommel","critical-pedagogy","digital-pedagogy","urgency-of-teachers","equity-unbound","maha-bali","catherine-cronin","mia-zamora","moocs","open-learning","frederick-douglass","hurricane-florence","todd-finley"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[Reading Science\|Reading Science]]","[[Ed-Tech Criticism\|Ed-Tech Criticism]]","[[Child Data Privacy\|Child Data Privacy]]","[[Critical Digital Pedagogy\|Critical Digital Pedagogy]]","[[Student Anxiety\|Student Anxiety]]"],"shelf":"archived","description":"Issue 165 children as customers examines Oprah Winfrey's use of touch and eye contact for empathy building, Emily Hanford's investigation revealing reading science being ignored in favor of ineffective methods, Jeff Bezos announcing child-as-customer preschools drawing criticism about Amazon values applied to education, investigative report on kids apps collecting extensive child data, teens protesting mandatory classroom presentations citing anxiety, Sean Michael Morris and Jesse Stommel releasing An Urgency of Teachers applying critical pedagogy to digital contexts, and Equity Unbound MOOC offering opportunities for global connection and equity-focused learning."}}
---
...
**Published**: 2018-09-14 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]
...
This week has been a jumble as we've been preparing for Hurricane Florence to head into the area. Classes were canceled starting on Tuesday and most people have heeded the evacuation warnings. My family has not heeded these warnings…and decided to stay at home. I've used this as an opportunity to start [playing with my 360 camera again](https://breadcrumbs.wiobyrne.com/yard-cleaned-up-and-waiting-for-florence/).

---

## 🔖 Key Takeaways

- **Reading Science Ignored**: Decades of research on phonics-based reading instruction remains ignored by many educators who resist evidence-based methods leaving millions of children unprepared to read.
- **Child as Customer**: Jeff Bezos's announcement that children will be "customers" in his preschool network reveals troubling application of Amazon's consumer obsession model to early childhood education.
- **Kids Apps Surveillance**: Free children's apps systematically collect extensive data on young users building detailed behavioral profiles that violate privacy principles and target vulnerable populations.
- **Presentation Anxiety**: Students protesting mandatory classroom presentations highlight tension between pushing learners beyond comfort zones and recognizing legitimate anxiety and mental health concerns.
- **Critical Digital Pedagogy**: Morris and Stommel's book examines how networked spaces require rethinking fundamental assumptions about power authority and learning relationships in education.

---

## 📺 Watch

### [Oprah Winfrey's Use of Touch and Eye Contact](http://www.todd-finley.com/home-page/)
...
Thanks to [Todd Finley](http://www.todd-finley.com/home-page/) and his [Inside Todd's Brain Newsletter](https://todd-finley.us11.list-manage.com/subscribe?u=82f89e650972d4bee408c19f5&id=b7794ca97d) for this link.

---

## 📚 Read

### [Hard Words: Why American Kids Aren't Being Taught to Read](https://www.apmreports.org/story/2018/09/10/hard-words-why-american-kids-arent-being-taught-to-read)

[Emily Hanford](https://twitter.com/ehanford) investigative report for American Public Media. Scientific research has shown how children learn to read and how they should be taught. But many educators don't know the science and, in some cases, actively resist it. As a result, millions of kids are being set up to fail.
...
All annotations in [context](https://hyp.is/go?url=https%3A%2F%2Fwww.apmreports.org%2Fstory%2F2018%2F09%2F10%2Fhard-words-why-american-kids-arent-being-taught-to-read).
...
### ['It's Like Amazon, But for Preschool'](http://hackeducation.com/2018/09/13/fuck-these-billionaires-and-their-bad-ideas)
...
"We'll use the same set of principles that have driven Amazon. Most important among those will be genuine, intense customer obsession," he [wrote on Twitter](https://twitter.com/JeffBezos/status/1040253796293795842). "The child will be the customer." The connection between the "values of Amazon" and bringing this to the lives of children drew a lot of criticism immediately online.

The lead link above is from [Audrey Watters](https://twitter.com/audreywatters) and provides the best overview of the problems in this view of education reform.
...
### [How Game Apps That Captivate Kids Have Been Collecting Their Data](https://www.nytimes.com/interactive/2018/09/12/technology/kids-apps-data-privacy-google-twitter.html)
...
### [Teens Are Protesting In-Class Presentations](https://www.theatlantic.com/education/archive/2018/09/teens-think-they-shouldnt-have-to-speak-in-front-of-the-class/570061/)
...
This week, a [tweet posted by a 15-year-old high-school student](https://twitter.com/softedhearts/status/1038376186894790658) declaring "Stop forcing students to present in front of the class and give them a choice not to" garnered more than 130,000 retweets and nearly half a million likes. A [similar sentiment tweeted in January](https://twitter.com/DAMNBlEBERS/status/826106798344126464) also racked up thousands of likes and retweets. And teachers are listening.
...
- Offering alternatives that develop communication skills without public performance (recorded presentations, written reports, small group discussions)
- Allowing students to present to teacher only or small groups rather than whole class
- Providing extensive preparation, practice opportunities, and support rather than high-stakes one-time performances
- Teaching anxiety management techniques alongside presentation skills
- Working with students individually to set appropriate challenges rather than one-size-fits-all requirements
- Recognizing that some students need therapeutic intervention before they're ready for public speaking practice
...
This week [Sean Michael Morris](http://www.twitter.com/slamteacher) and [Jesse Stommel](https://twitter.com/Jessifer) release a book they've been working on for years. This text seeks to sketch out what critical pedagogy looks like in a digital context.
...
Key themes include:
- **Trust over surveillance** - Building learning relationships rather than monitoring compliance
- **Agency over automation** - Preserving human judgment rather than outsourcing decisions to algorithms
- **Access over gatekeeping** - Opening education rather than protecting institutional boundaries
- **Care over efficiency** - Prioritizing relationships even when they don't scale
- **Justice over neutrality** - Acknowledging that technology decisions have political dimensions
...
### [Come Join Equity Unbound](http://unboundeq.creativitycourse.org/category/weeks-themes/intros/)
...
Equity Unbound was initiated by [Maha Bali](https://twitter.com/bali_maha) (American University in Cairo, Egypt), [Catherine Cronin](http://twitter.com/catherinecronin) (National University of Ireland, Galway), and [Mia Zamora](https://twitter.com/miazamoraphd) (Kean University, NJ, USA) for use in their courses this term (September-December 2018), but it is open to all. It's a powerful example of global and local nodes of learning. Come join us. :)
...
**Previous**: [[03 CREATE/33 Newsletter/TLDR 164\|TLDR 164]] • **Next**: [[03 CREATE/33 Newsletter/TLDR 166\|TLDR 166]] • **Archive**: [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

**🌱 Connected Concepts**:

- [[Reading Science\|Reading Science]] — Research on systematic phonics instruction showing how children learn to decode written language while teacher preparation programs often ignore or resist evidence-based methods in [[Literacy Education\|Literacy Education]].
...
- [[Critical Digital Pedagogy\|Critical Digital Pedagogy]] — [[Sean Michael Morris\|Sean Michael Morris]] and [[Jesse Stommel\|Jesse Stommel]] argue networked spaces require examining power relationships and resisting technological determinism in service of educational justice in [[Open Education\|Open Education]].
