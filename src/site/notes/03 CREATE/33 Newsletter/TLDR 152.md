---
{"dg-publish":true,"dg-permalink":"tldr-152","permalink":"/tldr-152/","title":"Too Long; Didn't Read Issue 152","tags":["digital-literacy","education-technology","stoicism","locus-of-control","blogging","small-b-blogging","personal-publishing","vector-animation","tank-short-film","stu-maschwitz","arcade-games","internet-trends","mary-meeker","digital-statistics","smartphone-saturation","wifi-networks","screen-time","epistemic-responsibility","belief-ethics","dan-denicola","truth-seeking","google-books","talk-to-books","machine-learning","natural-language-processing","semantic-search","critical-evaluation","source-credibility","technopanic","brain-effects","food-trucks","interactive-journalism","bullet-journal","productivity-systems","personal-organization","claude-levi-strauss","questioning","answer-machine","inquiry-based-learning","digital-content-creation"],"dg-note-properties":{"title":"Too Long; Didn't Read Issue 152","created":"2018-06-01","last_updated":"2025-12-13","status":"🌲_evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","stoicism","locus-of-control","blogging","small-b-blogging","personal-publishing","vector-animation","tank-short-film","stu-maschwitz","arcade-games","internet-trends","mary-meeker","digital-statistics","smartphone-saturation","wifi-networks","screen-time","epistemic-responsibility","belief-ethics","dan-denicola","truth-seeking","google-books","talk-to-books","machine-learning","natural-language-processing","semantic-search","critical-evaluation","source-credibility","technopanic","brain-effects","food-trucks","interactive-journalism","bullet-journal","productivity-systems","personal-organization","claude-levi-strauss","questioning","answer-machine","inquiry-based-learning","digital-content-creation"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[Stoic Locus Control\|Stoic Locus Control]]","[[Small B Big B Blogging\|Small B Big B Blogging]]","[[Internet Trends Meeker\|Internet Trends Meeker]]","[[Epistemic Responsibility Belief\|Epistemic Responsibility Belief]]","[[Talk to Books Google\|Talk to Books Google]]","[[Critical Source Evaluation\|Critical Source Evaluation]]"],"shelf":"archived","description":"Issue 152 the answer machine explores relationship between questions and answers through stoic philosophy guidance about identifying what we can control in our own lives via locus of control distinguishing between factors within and outside our influence allowing for more intentional living, blogging philosophies distinguishing between small-b personal reflective blogging and Big-B professional platform publishing examining why people write online and what different modes of digital expression serve, Mary Meeker's 2018 internet trends report showing global smartphone shipment growth has fallen to effectively nil with roughly 50 percent of world having internet access and average adult spending about 6 hours per day with digital devices demonstrating maturation of digital technologies and saturation in developed markets, Dan DeNicola's philosophical examination arguing we don't have right to believe whatever we want because beliefs carry epistemic responsibilities where true believers might not be believers in truth requiring vigilance about how we form and maintain beliefs in era of misinformation, Google's Talk to Books tool using machine learning to answer questions by reading thousands of books demonstrating natural language processing capabilities enabling semantic search across vast repositories of scanned literature, and critical evaluation challenges examining webpage that looks reputable but raises questions about authority and references demonstrating how checklist approaches to credibility assessment fail without deeper inquiry into sources and connections."}}
---
...
**Published**: 2018-06-01 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

Welcome to Issue 152. The answer machine.

This week I posted the following:

- [Identifying what we can control in our own lives](https://wiobyrne.com/identifying-what-we-can-control/) - This post provides some guidance from Stoic philosophies about your locus of control.
- [Blogging, small-b, Big B](https://wiobyrne.com/small-b-big-b/) - This post digs into my thinking about why I blog, and is motivated by this post from Aaron Davis among others.
...
### [TANK short film by Stu Maschwitz (2:44)](https://www.youtube.com/watch?v=YEdQ3mwyrQ4)
...
### [Mary Meeker's 2018 internet trends report: All the slides, plus analysis](https://www.recode.net/2018/5/30/17385116/mary-meeker-slides-internet-trends-code-conference-2018)
...
These trends reveal a shift from explosive growth to maturation, raising questions about what comes next as we move toward saturation of current technologies and platforms. You can review [all of her slides here](https://www.slideshare.net/kleinerperkins/internet-trends-report-2018-99574140).
...
### [Google's astounding new search tool will answer any question by reading thousands of books](https://qz.com/1252664/talk-to-books-at-ted-2018-ray-kurzweil-unveils-googles-astounding-new-search-tool-will-answer-any-question-by-reading-thousands-of-books/)
...
### [How technology affects the way our brain works](https://psychcentral.com/blog/%E2%80%8Bhow-technology-affects-the-way-our-brain-works/)
...
### [What's in a food truck?](https://www.washingtonpost.com/graphics/2018/food/food-trucks/)
...
### [Over 20 easy to copy Bullet Journal weekly spread ideas](https://sheenaofthejournal.com/bullet-journal/20-bullet-journal-weekly-spread-ideas/)
