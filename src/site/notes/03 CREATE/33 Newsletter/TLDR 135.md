---
{"dg-publish":true,"dg-permalink":"tldr-135","permalink":"/tldr-135/","title":"Too Long; Didn't Read Issue 135","tags":["digital-literacy","education-technology","how-computers-work","code-org","computer-science-education","social-media-bots","follower-factory","fake-followers","black-market","data-visualization","interactive-publishing","scientific-reproducibility","nature-journal","education-privacy","website-security","doug-levin","edtech-strategies","google-doc-activism","whistleblowing","collaborative-documents","stoic-philosophy","anger-management","seneca","screencast-o-matic","chromebooks","screen-recording"],"dg-note-properties":{"title":"Too Long; Didn't Read Issue 135","created":"2018-02-02","last_updated":"2025-12-19","status":"evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","how-computers-work","code-org","computer-science-education","social-media-bots","follower-factory","fake-followers","black-market","data-visualization","interactive-publishing","scientific-reproducibility","nature-journal","education-privacy","website-security","doug-levin","edtech-strategies","google-doc-activism","whistleblowing","collaborative-documents","stoic-philosophy","anger-management","seneca","screencast-o-matic","chromebooks","screen-recording"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[03 CREATE/32 Digitally Literate/Groves/Computer Science Education\|Computer Science Education]]","[[Social Media Bot Economy\|Social Media Bot Economy]]","[[Interactive Data Visualization\|Interactive Data Visualization]]","[[Education Website Privacy\|Education Website Privacy]]","[[Google Doc Activism\|Google Doc Activism]]","[[Stoic Anger Management\|Stoic Anger Management]]"],"shelf":"archived","description":"Issue 135 generosity between strangers explores Code.Org's six short videos explaining how computers work from data to circuits logic hardware and software, NY Times investigative piece exposing black market follower factory where bots are bought and sold despite social networks' ability to track fake entities, Nature article on data visualization tools driving interactivity and reproducibility in online publishing arguing act of reading paper in 1974 shouldn't be same as 2017, EdTech Strategies revealing most education agency websites lack secure browsing with extensive ad tracking and user surveillance, Google Doc activism providing underground whistleblowing platform for sensitive information, Stoic philosophy guidance on curbing anger as temporary madness through preemptive meditation and cognitive distancing, and Screencast-o-matic finally bringing free screen recording to Chromebooks."}}
---
...
**Published**: 2018-02-02 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

Welcome to Issue 135. Generosity between strangers.

This week I posted the following:
- [Assessing students as they read, research, & respond in Hypothesis](http://wiobyrne.com/assessing-hypothesis/) - A very granular look at how I assess student use of Hypothesis in two different classes. This is a supplement to [this video post](https://www.youtube.com/watch?v=CTYSxfvcong&t=).
- [Developing resilience & preparing for adversity](http://wiobyrne.com/resilience-and-adversity/) - This post discusses grit, mental toughness, and growth mindsets...and lessons learned from Stoic philosophies.
- [Cold brew coffee](http://wiobyrne.com/cold-brew-coffee/) - An update to my earlier post about cold brew. Mmmm...coffee.
- [Shape of a story](https://medium.com/rps-2k18/shape-of-a-story-966e0777fe26) - This post is the fifth learning event for my slam poetry class. We're studying the general shape involved in storytelling before we focus on telling our stories.
- Video: [A tale of two wikis to think through instructional design of an LMS](https://www.youtube.com/watch?v=ltX9gMkytxQ)
...
### [Introducing how computers work (playlist)](https://www.youtube.com/watch?v=OAx_6-wdslM&t=1s)

Great new series of six short videos that teach How Computers Work from [Code.Org](https://code.org/). Each video in the playlist is between 5 and 6 minutes long, and explains everything from data to circuits, logic, and hardware/software.
...
The piece closes with a quote from [Erez Lieberman Aiden](https://twitter.com/erezaterez) from the Baylor College of Medicine:
...
### [Tracking: EDU - Education agency website security and privacy practices](https://www.edtechstrategies.com/tracking-edu/)
...
[Doug Levin](https://twitter.com/douglevin) and the group behind [EdTech Strategies](https://www.edtechstrategies.com/) conducted an automated and manual review of every state department of education website and a nationwide sample of 159 school district websites. The study revealed that:
...
### [Your colleagues are probably sharing a secret Google Doc right now](https://work.qz.com/1194628/your-colleagues-are-probably-sharing-a-secret-google-doc-right-now/)
...
### [Anger is temporary madness: The stoics knew how to curb it](http://bigthink.com/aeon-ideas/anger-is-temporary-madness-the-stoics-knew-how-to-curb-it#ampshare=http://bigthink.com/aeon-ideas/anger-is-temporary-madness-the-stoics-knew-how-to-curb-it)
...
### [Screencast-o-matic comes to Chromebooks](https://cms.screencast-o-matic.com/blog/free-screen-recorder-chromebook/)

As far as I'm concerned, creating screen captures and screencasts is a necessary skill for educators and instructors from Pre-K up through higher ed. As I teach screencasting, I focus on my tool of choice, [Screencast-o-matic](https://screencast-o-matic.com/). One of the problems is that Screencast-o-matic did not work on Chromebooks. I also had to provide other options for tablets & mobile devices.

That all changes as a recent update to the product offers free screen recording on Chromebooks.

Keep in mind that there is a free and "pro" version of Screencast-o-matic. The Pro version will let you capture videos over 15 minutes in length, and remove the watermark, as well as adding a couple other features. If you would like to try out the Pro version for a year, you can [use my affiliate link](https://screencast-o-matic.com/refer/cIVoDAKg7) to get 20% off the Pro Recorder.
