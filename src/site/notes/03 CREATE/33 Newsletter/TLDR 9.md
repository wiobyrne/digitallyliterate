---
{"dg-publish":true,"dg-permalink":"tldr-9","permalink":"/tldr-9/","title":"Too Long; Didn't Read Issue 9","tags":["digital-literacy","education-technology","cofc-transition","computational-participation","coding","the-martian","horizon-reports","pew-research","creative-commons","chrome-apps","teacher-shortage","vhs-camcorder"],"dg-note-properties":{"title":"Too Long; Didn't Read Issue 9","created":"2015-08-22","last_updated":"2025-12-15","status":"🌲_evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","cofc-transition","computational-participation","coding","the-martian","horizon-reports","pew-research","creative-commons","chrome-apps","teacher-shortage","vhs-camcorder"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[Computational Participation\|Computational Participation]]","[[Coding in Education]]","[[NMC Horizon Reports\|NMC Horizon Reports]]","[[Creative Commons\|Creative Commons]]","[[Teacher Education Crisis\|Teacher Education Crisis]]"],"shelf":"archived","description":"Starting at CofC and unpacking the office, computational participation column with Quinn Burke and Yasmin Kafai, The Martian book recommendation, NMC Horizon Reports release, student-designed learning, Pew on mobile messaging, and VHS Camcorder app for creative video."}}
---

# TLDR 9

## Too Long; Didn't Read Issue 9

**Published**: 2015-08-22 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]
...
- **CofC Beginnings**: Orientation meetings with first-year faculty brimming with ideas, unpacking office, first department meeting.
- **Computational Participation**: New JAAL column with Quinn Burke and Yasmin Kafai on coding and programming as literacy activities.
- **The Martian**: Hard sci-fi Robinson Crusoe with disco—read the book before the movie, perfect for cross-curricular English/Science classes.
- **Horizon Reports Released**: NMC's annual tech trends for K-12, Libraries, and Higher Ed—all Creative Commons licensed.
- **Teacher Pipeline Crisis**: NPR reports on enrollment declines and teacher ed programs shutting down—larger societal issues at play.
...
The trailer for the movie version of [the fantastic Andy Weir book](https://en.wikipedia.org/wiki/The_Martian_(Weir_novel) was released this week. Do yourself a favor and [read the book](http://www.andyweirauthor.com/books/the-martian-tr/the-martian-hc)

before it comes out. The book is hard sci-fi with a Robinson Crusoe flair....[and disco](http://arstechnica.com/science/2014/11/stuck-on-mars-with-nothing-but-disco-ars-talks-with-the-martians-andy-weir/2/) .
...
From [All Things Considered](http://www.npr.org/programs/all-things-considered/)

on [NPR](http://www.npr.org/sections/ed/) , this is the first of two stories from NPR this week that shine on unflattering light on the educational system in the U.S.
...
[VHS Camcorder](http://rarevision.com/vhscam/) (sadly only on [iOs](https://itunes.apple.com/us/app/vhs-camcorder/id679454835?ls=1&mt=8) for now) distorts video in the same way we put filters on photos in Instagram. By forcing ourselves (and our students) to use media that is messy, distorted, and glitchy, we're possibly enabling them to be a bit more creative.

## 🤔 Consider

Starting at CofC this week brings excitement and possibility—new colleagues brimming with ideas, an office to unpack, familiar rhythms in unfamiliar spaces. Come knock on my door if you're in the area. :)

The computational participation column represents a shift in how we think about literacy. Coding isn't just a technical skill—it's a form of expression, a way of thinking, a literacy practice. When Quinn, Yasmin, and I talk about bringing programming into literacy classrooms, we're recognizing that writing code and writing text both involve composition, revision, and making meaning.

The Martian is more than a great sci-fi read—it's an example of how science, math, problem-solving, and storytelling intersect. "Read this book and read it now" isn't hyperbole. It's genuinely that good.

The teacher pipeline crisis mentioned in NPR's piece isn't just about enrollment numbers. It's about societal messages—what we value, who we support, what we're willing to invest in. When teacher ed programs shut down while the need for great teachers grows, something is deeply wrong. The money, leadership, and power dynamics behind this deserve scrutiny.

VHS Camcorder reminds us that perfection isn't always the goal. Sometimes messy, distorted, and glitchy opens creative doors that crystal-clear HD closes. Let students play with imperfection.

---

## 🔗 Navigation

**Previous**: [[03 CREATE/33 Newsletter/TLDR 8\|TLDR 8]] • **Next**: [[03 CREATE/33 Newsletter/TLDR 10\|TLDR 10]] • **Archive**: [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]
...
- **[[03 CREATE/36 Books/The Martian\|The Martian]]** — Hard sci-fi for cross-curricular English/Science classes, audiobook highly recommended.
...
- **[[Creative Commons\|Creative Commons]]** — Richard Byrne's resource collection on copyright and CC licensing.
- **[[Chrome Apps\|Chrome Apps]]** — Cross-device syncing and subject-specific app recommendations.
- **[[Innovation in Education\|Innovation in Education]]** — Can innovation be taught? Rethinking classroom instruction.
- **[[Web Literacies\|Web Literacies]]** — Elena Mortensen's synthesis of digital and web literacy frameworks.
- **[[Teacher Education Crisis\|Teacher Education Crisis]]** — Pipeline problem, program closures, societal devaluation.
- **[[VHS Camcorder\|VHS Camcorder]]** — Embracing messy, glitchy media to enable student creativity.
