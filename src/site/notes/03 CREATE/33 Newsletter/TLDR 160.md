---
{"dg-publish":true,"dg-permalink":"tldr-160","permalink":"/tldr-160/","title":"Too Long; Didn't Read Issue 160","tags":["digital-literacy","education-technology","harmful-discourses","classroom-resistance","bullying","harassment","hate-speech","asmr","focus-techniques","ambient-audio","sinan-aral","false-news","misinformation-spread","truth-disruption","facial-recognition","summer-camps","surveillance-concerns","parent-monitoring","mental-health-apps","headspace","therapy-apps","data-privacy","digital-therapy","social-media-india","whatsapp-lynchings","technology-dualities","dissect-podcast","kendrick-lamar","music-analysis","slow-content","deep-dive","repurposing-content","academic-accessibility","dan-quintana","social-media-talks","ralph-waldo-emerson","authenticity"],"dg-note-properties":{"title":"Too Long; Didn't Read Issue 160","created":"2018-07-28","last_updated":"2025-12-13","status":"🌲_evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","harmful-discourses","classroom-resistance","bullying","harassment","hate-speech","asmr","focus-techniques","ambient-audio","sinan-aral","false-news","misinformation-spread","truth-disruption","facial-recognition","summer-camps","surveillance-concerns","parent-monitoring","mental-health-apps","headspace","therapy-apps","data-privacy","digital-therapy","social-media-india","whatsapp-lynchings","technology-dualities","dissect-podcast","kendrick-lamar","music-analysis","slow-content","deep-dive","repurposing-content","academic-accessibility","dan-quintana","social-media-talks","ralph-waldo-emerson","authenticity"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[Harmful Discourses Resistance\|Harmful Discourses Resistance]]","[[False News Spread\|False News Spread]]","[[Facial Recognition Surveillance\|Facial Recognition Surveillance]]","[[Mental Health Apps Privacy\|Mental Health Apps Privacy]]"],"shelf":"archived","description":"Issue 160 identifying your piece in the puzzle shares published research on employing digital spaces to resist harmful discourses with supplemental post for educators addressing bullying and hate speech in classrooms, ASMR as focus tool, Sinan Aral research showing false news spreads faster farther and deeper than truth online, summer camps using facial recognition raising privacy concerns, mental health apps research questioning data practices and need for human connection alongside digital therapy, social media in India both tearing apart and bringing together, Dissect podcast analyzing albums song by song as antidote to swipe culture, and Dan Quintana guidance on repurposing academic talks for social media accessibility."}}
---
...
**Published**: 2018-07-28 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

Welcome to Issue 160. Identifying your piece in the puzzle.

This week I posted the following:

- [Employing digital spaces to resist harmful discourses: Intersections of learning, technology, & politics showing up in the lowcountry](https://www.tandfonline.com/eprint/DWaYDK588Gfbi45Q9rtX/full) - I've shared a lot of parts of this research project, but it has finally been published. The full manuscript should be available above. If not, send me an email.
- [Encountering harmful discourses in the classroom](https://wiobyrne.com/encountering-harmful-discourses-in-the-classroom/) - This post is a supplement of the work published above. This is for the educator that is trying to figure out how to address bullying, harassment, and hate speech in their classroom.
...
- **Resisting Harmful Discourses**: Research explores how educators can employ digital spaces to address and resist bullying, harassment, and hate speech in classrooms.
- **False News Velocity**: Sinan Aral's research reveals false news spreads faster, farther, and deeper than truth online but can be contained with proper interventions.
- **Surveillance Creep**: Summer camps using facial recognition for parent photos exemplifies expanding reach of surveillance technology into everyday activities raising privacy questions.
- **Mental Health App Concerns**: Research on 61 mental health apps reveals data privacy issues and highlights need for human connection alongside digital therapy tools.
- **Technology Dualities**: Social media in India demonstrates how same platforms can tear communities apart through misinformation while bringing people closer through connection.
...
To get started, check [this video from Gibi](https://www.youtube.com/watch?v=vFqbWwKg_o4&feature=youtu.be). One of my recent favorites is [this video](https://www.youtube.com/watch?v=X5F-Z4xEVhw) from the ASMRctica ASMR channel.
...
### [The truth about false news](https://hbr.org/2018/07/the-truth-about-false-news)

Sinan Aral in the Harvard Business Review posits that false news spreads online faster, farther, and deeper than truth does—but it can be contained. This post identifies a lot of [interesting data points](https://breadcrumbs.wiobyrne.com/truth-disrupted/) on how truth moves about online.

Key findings from the research:
- False news reaches 1,500 people six times faster than true news
- False political news spreads deeper and more broadly than any other category
- Humans, not bots, are primarily responsible for spreading false news
- False news is 70% more likely to be retweeted than true news
- False news inspires fear, disgust, and surprise whereas true news inspires anticipation, sadness, joy, and trust

HBR also shares supplementary posts on [what do we know about false news](https://hbr.org/2018/07/what-do-we-know-about-false-news), and [how we all can fight misinformation](https://hbr.org/2018/07/how-we-all-can-fight-misinformation#).
...
### [Hey Mom, did you see this? Camps are using facial recognition](https://www.usatoday.com/story/tech/news/2018/07/17/facial-recognition-helps-mom-and-dad-see-kids-camp-photos-raises-privacy-concerns-some/780725002/)
...
### [How mental health apps are messing with our heads](https://vitals.lifehacker.com/how-mental-health-apps-are-messing-with-our-heads-1827727989)

I've blogged quite a bit about my meditation habit, and how the Headspace app helped me start this practice. This post from Lisa Parker at the University of Sydney discusses her research on 61 apps and [published work](http://www.annfammed.org/content/16/4/338.full#ref-10). The research suggests questions that we should be asking about what these apps are doing with our data, and potential threats to privacy and security in digital spaces.

Key findings:
- Most apps lack evidence base for their therapeutic claims
- Privacy policies often vague or nonexistent
- Data sharing practices frequently unclear
- Many apps collect sensitive health information without adequate protection
- Commercial interests may conflict with therapeutic goals
...
### [Social media is tearing Indians apart but it can also bring them closer](https://qz.com/1340559/india-shouldnt-restrict-whatsapp-and-social-media-despite-lynchings/)
...
### [The Dissect Podcast](https://dissectpodcast.com/)
...
A good friend, Mike Manderino, recommended the Dissect Podcast. The podcast is motivated by the "swipe culture" in which we hurriedly rush from content to content to content. As a potential [antidote](https://www.billboard.com/articles/business/8456738/dissect-podcast-cole-cuchna-kanye-frank-ocean-spotlight-interview), host Cole Cuchna focuses each season on one album, and each episode analyzes one song, measure by measure, word by word.
...
Subscribe to Dissect now on [Apple Podcasts](http://apple.co/2bxXWgV), [Stitcher](http://www.stitcher.com/s?fid=97889), [Google Play](http://bit.ly/2ciY7x6), [iTunes](http://itunes.com/dissect) or wherever you get your podcasts.
...
### [Repurpose your talks on social media](https://breadcrumbs.wiobyrne.com/repurposing-talks-on-social-media/)
...
- Extract key points as tweet threads
- Create visual summaries
- Share slides with annotations
- Write accessible blog posts translating jargon
- Build multiple entry points to same content
...
**Previous**: [[03 CREATE/33 Newsletter/TLDR 159\|TLDR 159]] • **Next**: [[03 CREATE/33 Newsletter/TLDR 161\|TLDR 161]] • **Archive**: [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

**🌱 Connected Concepts**:

- [[Harmful Discourses Resistance\|Harmful Discourses Resistance]] — Published research explores how educators employ [[Digital Spaces\|Digital Spaces]] to resist bullying harassment and hate speech in classrooms providing practical guidance for addressing harmful content in [[Educational Contexts\|Educational Contexts]].
- [[False News Spread\|False News Spread]] — [[Sinan Aral\|Sinan Aral]] research reveals false news reaches 1500 people six times faster than truth with humans not bots responsible for spread driven by novelty and emotional arousal in [[Information Ecosystems\|Information Ecosystems]].
- [[Facial Recognition Surveillance\|Facial Recognition Surveillance]] — Summer camps using facial recognition for parent photos exemplifies expanding reach of surveillance justified through convenience and care normalizing constant monitoring for children in [[02 CURATE/Privacy erosion\|Privacy erosion]].
- [[Mental Health Apps Privacy\|Mental Health Apps Privacy]] — Research on 61 apps reveals data privacy concerns and need for human connection alongside digital therapy tools as commercial interests may conflict with therapeutic goals in [[Digital Healthcare\|Digital Healthcare]].
- [[Technology Dualities\|Technology Dualities]] — Social media in India demonstrates same platforms can tear communities apart through misinformation while bringing people closer through connection requiring nuanced understanding beyond inherently good or bad framing in [[Platform Effects\|Platform Effects]].
