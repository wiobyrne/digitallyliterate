---
{"dg-publish":true,"dg-permalink":"tldr-77","permalink":"/tldr-77/","title":"Too Long; Didn't Read Issue 77","tags":["digital-literacy","education-technology","process-vs-product","growth-mindset","carol-dweck","assessment","signal-messenger","formative-assessment","time-management","bread-making"],"dg-note-properties":{"title":"Too Long; Didn't Read Issue 77","created":"2016-12-23","last_updated":"2025-12-18","status":"🌲_evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","process-vs-product","growth-mindset","carol-dweck","assessment","signal-messenger","formative-assessment","time-management","bread-making"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[Process vs Product\|Process vs Product]]","[[Growth Mindset\|Growth Mindset]]","[[Carol Dweck\|Carol Dweck]]","[[Assessment\|Assessment]]","[[Signal Messenger\|Signal Messenger]]","[[Graham Brown-Martin\|Graham Brown-Martin]]","[[Joe Bower\|Joe Bower]]","[[Formative Assessment\|Formative Assessment]]","[[Bread Making\|Bread Making]]"],"shelf":"archived","description":"Issue 77 - process as opposed to product. Signal instant messenger I suggest that you install and start to use, text disruption for youth disruptors I'd love your comments, YouTube girl mastered dubstep dancing powerful video, Carol Dweck growth mindset I'm intrigued by her focus on praise effort and work process, assessment is not a spreadsheet it's a conversation one of anecdotes will guide my work, image-based formative assessments in my classes I indicate it is imperative, and bread class I love experimenting I'll be mimicking this format soon."}}
---
...
**Published**: 2016-12-23 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]
...
- [Signal instant messenger](http://wiobyrne.com/imho/2016/signal) - I've been promising over the past month or two that I'd start documenting the steps that I'm taking to improve my privacy and security with digital tools. This post is the first in the series as I examine/install Signal. I suggest that you install and start to use Signal as well.
- [Text disruption for youth disruptors](https://docs.google.com/document/d/1cm_klzldoVDWeLlTZWOMzwQHhaAUGDhim3oewjjZ_xU/edit?usp=sharing) - This is a piece that I wrote with Susanne Murphy in which we're looking at the opportunities to use children's books as a teaching tool to discuss critical media literacies. I'm fine-tuning some of the elements of the submission and will send in for review within the next week. I'd love your comments if you've got the time.
...
### [This amazing girl mastered dubstep dancing by just using YouTube](https://www.youtube.com/watch?v=OgzdDp5qfdI)
...
### [Assessment is not a spreadsheet, it's a conversation](https://medium.com/learning-re-imagined/assessment-is-not-a-spreadsheet-its-a-conversation-3d743c754809#.d78lfjq0q)

A post from [Graham Brown-Martin](https://twitter.com/GrahamBM) in which he recounts a discussion with educator [Joe Bower](https://twitter.com/joe_bower). Joe [recently passed away](https://dianeravitch.net/2016/01/03/r-i-p-joe-bower/) at the beginning of January.
...
### [Three ways to create image-based formative assessments](http://www.freetech4teachers.com/2016/12/three-ways-to-create-image-based.html)
...
Think about the possibilities as you annotate an image from your computer screen. Think about the questions you can ask students about this content. Byrne shares a couple tools ([Formative](http://goformative.com/), [Wizer](http://app.wizer.me/), [Google Forms](http://forms.google.com/)) that can be used to create an assessment item from this image.

---

### [The digital research process visually explained](http://www.educatorstechnology.com/2016/12/the-digital-research-process-visually.html)
...
### [Bread class](http://www.instructables.com/class/Bread-Class/)

I'm sharing this class from [Instructables](http://www.instructables.com/) for two reasons.
...
**Previous**: [[03 CREATE/33 Newsletter/TLDR 76\|TLDR 76]] • **Next**: [[03 CREATE/33 Newsletter/TLDR 78\|TLDR 78]] • **Archive**: [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

**🌱 Connected Concepts**:

- **[[Process vs Product\|Process vs Product]]** — Carol Dweck focus on praise effort and work process as opposed to product, praise the effort that led to outcome not just effort but strategy.
- **[[Growth Mindset\|Growth Mindset]]** — Carol Dweck term being misappropriated as we work with learners, effective teachers supporting children's learning strategies showing how strategies created success.
- **[[Carol Dweck\|Carol Dweck]]** — Researcher helped coin growth mindset discusses challenges of perspective, I'm intrigued by her focus on praise effort and work process.
- **[[Assessment\|Assessment]]** — Not a spreadsheet it's a conversation Graham Brown-Martin, discussions about education assessment and supporting learners one of anecdotes will guide my work.
- **[[Signal Messenger\|Signal Messenger]]** — I've been promising documenting steps improving privacy and security, first in the series I suggest you install and start to use Signal as well.
- **[[Graham Brown-Martin\|Graham Brown-Martin]]** — Post recounting discussion with educator Joe Bower, shares some insight into discussions about education assessment supporting learners.
- **[[Joe Bower\|Joe Bower]]** — Educator recently passed away beginning of January, what the hell is water school is the water we've been in it so long we don't see it.
- **[[Formative Assessment\|Formative Assessment]]** — Image-based three ways create Richard Byrne, in my classes I indicate imperative educators students know screencaptures screencasts tools Formative Wizer Google Forms.
- **[[Bread Making\|Bread Making]]** — Instructables class I love experimenting with dough to make great bread and pizza, I enjoy way they organize materials I'll be mimicking this format soon.
