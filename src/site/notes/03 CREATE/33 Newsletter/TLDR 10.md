---
{"dg-publish":true,"dg-permalink":"tldr-10","permalink":"/tldr-10/","title":"Too Long; Didn't Read Issue 10","tags":["digital-literacy","education-technology","cofc-teaching","chrome-workflow","wordpress","manuel-lima","trigger-warnings","mobile-etiquette","explain-everything","hypertext","school-safety","tony-wagner"],"dg-note-properties":{"title":"Too Long; Didn't Read Issue 10","created":"2015-08-28","last_updated":"2025-12-15","status":"🌲_evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","cofc-teaching","chrome-workflow","wordpress","manuel-lima","trigger-warnings","mobile-etiquette","explain-everything","hypertext","school-safety","tony-wagner"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[Manuel Lima\|Manuel Lima]]","[[Pew Research\|Pew Research]]","[[WordPress\|WordPress]]","[[Chrome Extensions\|Chrome Extensions]]","[[Explain Everything\|Explain Everything]]","[[Play and Passion in Education\|Play and Passion in Education]]"],"shelf":"archived","description":"Over 100 subscribers celebration, teaching first CofC class, Chrome workflow and WordPress tweaks, Manuel Lima on knowledge visualization, trigger warnings debate, mobile etiquette research, Explain Everything on Chrome, hypertext's 50th anniversary, and Tony Wagner on play, passion, and purpose."}}
---
...
**Published**: 2015-08-28 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]
...
- **100+ Subscribers**: Celebrating tenth issue milestone—thanks for the support!
- **First CofC Class**: Met first group of students, attending committee meetings, getting started.
- **Chrome Workflow**: Sharing digital tools and extensions used across Mac & PC.
- **Manuel Lima's Knowledge Map**: Thousand-year visual history revealing how interconnected human knowledge really is.
- **Tony Wagner's 7 Essentials**: Play, passion, and purpose—formulate questions, communicate, adapt, take initiative, create.
...
[SharAlike](https://sharalike.com/) is a free tool that makes it quick and easy to mix photos together to create an audio slideshow. It is available on iOS (iPhone/iPad), (soon to be on) Android, and as a web app.
...
**Previous**: [[03 CREATE/33 Newsletter/TLDR 9\|TLDR 9]] • **Next**: [[03 CREATE/33 Newsletter/TLDR 11\|TLDR 11]] • **Archive**: [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

**🌱 Connected Concepts**:

- **[[Manuel Lima\|Manuel Lima]]** — Visual history of human knowledge revealing interconnectedness.
- **[[Chrome Extensions\|Chrome Extensions]]** — Cross-device workflow tools and productivity extensions.
- **[[WordPress\|WordPress]]** — Building, breaking, iterating on blog themes and plugins.
- **[[Trigger Warnings\|Trigger Warnings]]** — Atlantic piece on coddling vs. preparing students.
- **[[Pew Research\|Pew Research]]** — Mobile etiquette and ubiquitous connectivity challenges.
- **[[Explain Everything\|Explain Everything]]** — Multimodal tutorials, documenting thinking aloud on Chrome.
- **[[Hypertext History\|Hypertext History]]** — Ted Nelson coining "hypertext" 50 years ago (1965).
- **[[School Safety\|School Safety]]** — Active shooter preparation, FBI training, responsibility over paranoia.
- **[[Tony Wagner\|Tony Wagner]]** — Seven essentials for lifelong learners: question, communicate, adapt, initiate, create.
- **[[Play and Passion in Education\|Play and Passion in Education]]** — Making space for student purpose through play.
- **[[ShareAlike\|ShareAlike]]** — Audio slideshows for creative digital content exploration.
