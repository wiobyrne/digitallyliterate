---
{"dg-publish":true,"dg-permalink":"tldr-185","permalink":"/tldr-185/","title":"Becoming the Machine","tags":["digital-literacy","education-technology","screentime-addiction","motivation-framing","addiction-language","creative-commons","image-finding","website-citations","text-definition","podcasts-emoji-memes","peppa-pig-meme","oliver-sacks","machine-stops","em-forster","1909-story","prescient-fiction","separate-cells","audio-visual-devices","mirrorworld","ar-platform","kevin-kelly","next-big-thing","1-to-1-map","physical-digital-merge","david-gelernter","context-meaning-function","two-codes","thomas-friedman","college-board","computer-science","us-constitution","empowered-citizens","navigating-society","shaping-institutions","autocomplete","predictive-text-meme","best-version-you","instagram-filter","social-media-sharing","college-costs","physicist-teacher","english-major","working-paper","professor-salaries","class-size","education-factors","food-hacks-kids","dreamworks-tv","cooking-experimentation","kitchen-learning","carol-dweck","becoming-being","growth-mindset"],"dg-note-properties":{"title":"Becoming the Machine","created":"2019-02-15","last_updated":"2025-12-13","status":"🌲_evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","screentime-addiction","motivation-framing","addiction-language","creative-commons","image-finding","website-citations","text-definition","podcasts-emoji-memes","peppa-pig-meme","oliver-sacks","machine-stops","em-forster","1909-story","prescient-fiction","separate-cells","audio-visual-devices","mirrorworld","ar-platform","kevin-kelly","next-big-thing","1-to-1-map","physical-digital-merge","david-gelernter","context-meaning-function","two-codes","thomas-friedman","college-board","computer-science","us-constitution","empowered-citizens","navigating-society","shaping-institutions","autocomplete","predictive-text-meme","best-version-you","instagram-filter","social-media-sharing","college-costs","physicist-teacher","english-major","working-paper","professor-salaries","class-size","education-factors","food-hacks-kids","dreamworks-tv","cooking-experimentation","kitchen-learning","carol-dweck","becoming-being","growth-mindset"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[Machine Stops Prescience\|Machine Stops Prescience]]","[[Mirrorworld AR Future\|Mirrorworld AR Future]]","[[Two Codes Education\|Two Codes Education]]","[[Autocomplete Instagram Filter\|Autocomplete Instagram Filter]]"],"shelf":"archived","description":"Issue 185 becoming the machine examines Oliver Sacks noting parallels between modern world and E.M. Forster's 1909 \"Machine Stops\" predicting separate cells communicating through devices, Kevin Kelly's mirrorworld describing AR as next platform merging physical and digital reality through 1-to-1 maps, College Board arguing students need two codes for empowerment—computer science and U.S. Constitution—to shape rather than be shaped by systems, and autocomplete presenting Instagram-filtered version of ourselves through predictive text."}}
---
...
**Published**: 2019-02-15 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]
...
- [Motivations behind "screentime addiction"](https://screentime.me/motivation-behind-screentime-addiction/) - In this post I'm starting to unpack some of my thinking about framing digital use as an "addiction."
- [Finding & using Creative Commons images on your website](https://www.youtube.com/watch?v=UQfNkYD__6Y&feature=youtu.be) - An overview of the guidance I provide on for finding/using/citing images on your website.

---

## 🔖 Key Takeaways

- **Machine Stops Prescience**: Oliver Sacks noting parallels between modern world and E.M. Forster's 1909 story predicting humans living in separate cells communicating only through audio-visual devices reveals prescient warning about isolation.
- **Mirrorworld AR Platform**: Kevin Kelly describing next big platform as 1-to-1 digital map merging physical reality with digital universe where we interact with context meaning and function not just appearance.
- **Two Codes Empowerment**: College Board arguing students need computer science to shape technology and U.S. Constitution understanding to shape democracy preventing institutions from shaping them instead.
- **Autocomplete Instagram Filter**: Predictive text memes presenting best version of ourselves through verbal equivalent of Instagram filter making us feel seen while reassuring human superiority over machines.
- **Education Cost Variation**: Working paper showing teaching physicist or teacher costs colleges far more than English major due to professor salaries equipment and class sizes revealing hidden subsidy structures.

---

## 📺 Watch

### [Peppa Pig Whistle Meme](https://www.youtube.com/)
...
### [The Machine Stops](https://www.nytimes.com/)

This short essay was written by [Oliver Sacks](https://en.wikipedia.org/wiki/Oliver_Sacks) shortly before his death from cancer in 2015.

In this essay, Sacks notes the parallels between the modern world he sees around him and E.M. Forster's prescient classic 1909 short story ["The Machine Stops,"](https://en.wikisource.org/wiki/The_Machine_Stops) in which Forster imagined a future in which humans lived in separate cells, communicating only by audio and visual devices.
...
[Kevin Kelly](https://twitter.com/kevin2kelly) on the ["next big thing after the next big thing."](https://twitter.com/kevin2kelly/status/1095371054569017344) How we are building a 1-to-1 map of almost unimaginable scope. When it's complete, our physical reality will merge with the digital universe.
...
### [The Two Codes Your Kids Need to Know](https://www.nytimes.com/2019/02/12/opinion/college-board-sat-ap.html)

This opinion from [Thomas Friedman](https://twitter.com/tomfriedman) shares insight from The College Board, and a surprising conclusion about keys to success for college and life. Not surprisingly, they indicate that students need the ability to master **"two codes"** — computer science and the U.S. Constitution.
...
### [Food Hacks for Kids](https://www.youtube.com/playlist?list=PLMdKMaqxA079RTKEWfqVhAqyOkFQdmW3-)

Thanks to the YouTube algorithms, this week we found the [Food Hacks for Kids series](https://www.youtube.com/playlist?list=PLMdKMaqxA079RTKEWfqVhAqyOkFQdmW3-) on the [DreamWorks TV YouTube channel](https://www.youtube.com/channel/UCY26xU0-avwTJ6F6TzUZVEw).
...
**Previous**: [[03 CREATE/33 Newsletter/TLDR 184\|TLDR 184]] • **Next**: [[03 CREATE/33 Newsletter/TLDR 186\|TLDR 186]] • **Archive**: [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

**🌱 Connected Concepts**:

- [[Machine Stops Prescience\|Machine Stops Prescience]] — [[Oliver Sacks\|Oliver Sacks]] noting parallels between modern world and [[E.M. Forster\|E.M. Forster]] 1909 story predicting humans in separate cells communicating through devices in [[Technology Criticism\|Technology Criticism]].
- [[Mirrorworld AR Future\|Mirrorworld AR Future]] — [[Kevin Kelly\|Kevin Kelly]] describing next platform as 1-to-1 digital map merging physical and digital reality where we interact with context meaning and function in [[Augmented Reality\|Augmented Reality]].
- [[Two Codes Education\|Two Codes Education]] — [[Thomas Friedman\|Thomas Friedman]] sharing College Board argument students need computer science and Constitution understanding to shape systems rather than be shaped by them in [[Civic Education\|Civic Education]].
- [[Autocomplete Instagram Filter\|Autocomplete Instagram Filter]] — Predictive text presenting machine-legible best version of ourselves through verbal Instagram filter while maintaining illusion of human superiority in [[Human-AI Interaction\|Human-AI Interaction]].
- [[Education Cost Subsidy\|Education Cost Subsidy]] — Working paper revealing humanities subsidizing STEM through lower costs exposing hidden subsidy structures in higher education funding in [[Higher Education Economics\|Higher Education Economics]].
