---
{"dg-publish":true,"dg-permalink":"tldr-61","permalink":"/tldr-61/","title":"Too Long; Didn't Read Issue 61","tags":["digital-literacy","education-technology","getting-to-know-you","dwayne-reed","book-reading","ebooks","facebook-privacy","hipaa","algorithms","cathy-oneil","iwishmyteacherknew","google-certified-trainer"],"dg-note-properties":{"title":"Too Long; Didn't Read Issue 61","created":"2016-09-02","last_updated":"2025-12-17","status":"🌲_evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","getting-to-know-you","dwayne-reed","book-reading","ebooks","facebook-privacy","hipaa","algorithms","cathy-oneil","iwishmyteacherknew","google-certified-trainer"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[Book Reading\|Book Reading]]","[[E-books\|E-books]]","[[Facebook Privacy\|Facebook Privacy]]","[[Algorithms\|Algorithms]]","[[01 CONSUME/16 People/Cathy O'Neil\|Cathy O'Neil]]","[[I Wish My Teacher Knew\|I Wish My Teacher Knew]]","[[Google for Education\|Google for Education]]"],"shelf":"archived","description":"Issue 61 - getting to know you. Dwayne Reed fourth grade autotuned video going viral, Pew Research on book reading print vs ebooks, Facebook psychiatrist privacy violation HIPAA concerns, Cathy O'Neil on algorithms ruling working lives and 72% of CVs never seen by human eyes, #iwishmyteacherknew heartbreaking and uplifting reality check, Google for Education Certified Trainer program, and logic puzzles easter eggs for students."}}
---
...
**Published**: 2016-09-02 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]
...
- **I Know That It Makes Me**: I'm sharing this out with my students as en exemplar for what they could create. I know that it makes me want to create an autotuned version of my own video.
- **What I Find Most Intriguing**: College graduates are roughly four times as likely to read e-books and about twice as likely to read print books and audio books – compared with those who have not graduated high school. What I find most intriguing.
- **This Is Not Good**: Facebook recommended that this psychiatrist's patients friend each other. This is not good.
- **One Piece That Will Stick**: One piece that will stick to me from this post, "In the US, some 72% of CVs are never seen by human eyes. Computer programs flip through them."
- **I May Join You**: Chances are, if you're a regular reader of TL;DR, you're also a big fan of Google. I may join you in the process. :)

---

## 📺 Watch

### [Welcome to the fourth grade - Dwayne Reed](https://www.youtube.com/watch?v=XBLcuGunRxU)
...
### [Pew Research Report: Book reading 2016](http://www.pewinternet.org/2016/09/01/book-reading-2016/)
...
We've seen Facebook play it fast and loose with user privacy and security in the past. Most recently, Facebook and WhatsApp [have been under fire](http://www.independent.co.uk/life-style/gadgets-and-tech/news/whatsapp-facebook-data-sharing-ads-privacy-information-how-to-opt-out-messaging-a7218121.html) after they announced that they will indeed reverse course and share user info across the two spaces.
...
This is a gigantic privacy violation. This is especially problematic given [HIPAA](http://www.dhcs.ca.gov/formsandpubs/laws/hipaa/Pages/1.00WhatisHIPAA.aspx) information regulations here in the U.S. I can see problematic situations also arising with FERPA and anonymity requests made in research and reporting.

Facebook has not commented, but [Kashmir Hill](https://twitter.com/kashhill) (the author of the post) tries to identify possible reasons the algorithm picked up these connections. It could be a new feature on Facebook and mobile in which the app is looking at cell phone data, location, and trying to connect people at the local level. It could also be Facebook connecting similar phone numbers across users. As an example, if I have my doctor's phone number saved to my device, I might not be friends with the other individuals that visit my doctor, but Facebook might try to connect the dots and suggest that we become friends.
...
Great long form post from [Cathy O'Neil](https://twitter.com/mathbabedotorg) in The Guardian. After reading this post, I subscribed to Cathy's blog [MathBabe](https://mathbabe.org/) in my Feedly reader.
...
### [What kids wish their teachers knew](http://www.nytimes.com/2016/08/31/well/family/what-kids-wish-their-teachers-knew.html?_r=0)
...
Click on the link above to view some of the shared pieces...or [search](https://twitter.com/search?q=%23iwishmyteacherknew&src=typd&lang=en-gb) (and join in) on your own.

---

### [The new Google for Education Certified Teacher Program](http://googleforeducation.blogspot.com/2016/09/teaching-teachers-new-google-for.html)

Chances are, if you're a regular reader of TL;DR, you're also a big fan of Google, Google Apps, and some of the cool tools sprinkled across these spaces. If so, you might be interested in joining in the new opportunity to train to be a [Google for Education Certified Trainer](https://edutrainingcenter.withgoogle.com/certification_trainer).
...
**Previous**: [[03 CREATE/33 Newsletter/TLDR 60\|TLDR 60]] • **Next**: [[03 CREATE/33 Newsletter/TLDR 62\|TLDR 62]] • **Archive**: [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

**🌱 Connected Concepts**:

- **[[Book Reading\|Book Reading]]** — Pew Research print remains center, ebook consumption tripled since 2011, multipurpose devices over e-readers.
...
- **[[01 CONSUME/16 People/Cathy O'Neil\|Cathy O'Neil]]** — MathBabe subscribed after reading, employers using math to weed applications automatically.
