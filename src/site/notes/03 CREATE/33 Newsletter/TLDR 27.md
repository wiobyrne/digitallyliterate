---
{"dg-publish":true,"dg-permalink":"tldr-27","permalink":"/tldr-27/","title":"Too Long; Didn't Read Issue 27","tags":["digital-literacy","education-technology","walkmyworld","digital-identity","computational-thinking","coding","transmedia-storytelling","privacy","slack","trello","podcasting","ted-ed","nypl","public-domain","pew-research","parental-monitoring","chromebooks","ipads","moocs","barbara-oakley","eye-contact","video-editing"],"dg-note-properties":{"title":"Too Long; Didn't Read Issue 27","created":"2016-01-08","last_updated":"2025-12-16","status":"🌲_evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","walkmyworld","digital-identity","computational-thinking","coding","transmedia-storytelling","privacy","slack","trello","podcasting","ted-ed","nypl","public-domain","pew-research","parental-monitoring","chromebooks","ipads","moocs","barbara-oakley","eye-contact","video-editing"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[WalkMyWorld Project\|WalkMyWorld Project]]","[[02 CURATE/Digital Identity\|Digital Identity]]","[[03 CREATE/32 Blog/2020/Computational Thinking\|Computational Thinking]]","[[03 CREATE/32 Blog/2015/Transmedia Storytelling\|Transmedia Storytelling]]","[[AdvocatED\|AdvocatED]]","[[Privacy]]","[[Pew Research\|Pew Research]]","[[MOOCs]]"],"shelf":"archived","description":"Welcome new year 2016 relax reflect celebrate, six pieces accomplished: Social Scholars WalkMyWorld digital identity construction, Computational Participation JAAL coding programming as literacy, New Hope transmedia storytelling fold in comments as we go to press, Privacy Identity AdvocatED protecting yourself students, Slack Trello organizing podcasting, Work with cool people stuff you love open letter inspire innovation. NYPL public domain collection data dumps drowning people, Pew parents teens digital monitoring want to dig into elements, writing on screens Microsoft-funded Surface ad hidden in research pedagogy, I usually advise Chromebooks opposed to iPads proper kit might include both plus stylus mouse, new pedagogy emerging seven trends, Barbara Oakley MOOCs rallying cry motivating force for those of us trying to build and share, and pupil size trust I'm fascinated by role of eye contact often find my eyes wandering around."}}
---
...
**Published**: 2016-01-08 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]
...
- [Social Scholars: Educators' digital identity construction in open, online learning environments](http://wiobyrne.com/social-scholars/) - This piece examined participants in the WalkMyWorld Project from two years ago and highlights challenges as educators create and curate an online brand.
- [Computational Participation: Coding and programming as literacy activities](http://wiobyrne.com/computational-participation-coding-and-programming-as-literacy-activities/) - This JAAL column was published just this week. It examines possibilities to embed "computational thinking and participation" in the classroom as opposed to just a focus on coding/programming. We'll hold interviews over the coming weeks...so let me know if you want to be involved, or have someone I should chat with.
- [A New Hope: Negotiating the integration of transmedia storytelling & literacy instruction](http://wiobyrne.com/transmedia-storytelling-literacy-instruction/) - This column was just submitted to JAAL this week. In it we're trying to tackle digital storytelling and transmedia narratives in the literacy classroom. Please feel free to leave comments on the Google Doc we share in the post. We'll fold in your comments as we go to press.
- [Privacy, Identity, & Protecting Yourself (and your students) online](https://medium.com/advocat-ed/privacy-identity-protecting-yourself-and-your-students-online-1a4ed075fe25#.uai8kx9d6) - This piece was shared on the [AdvocatED Medium pub](https://medium.com/advocat-ed). In it I identify possibilities to educate, empower, and advocate for others in online spaces.
- [Using Slack and Trello to organize a podcasting series about literacy education and research](http://wiobyrne.com/slack-trello-to-organize-podcasting-series/) - This post discusses the use of these two tools to organize and plan our Research to Practice podcast series.

The final piece I shared this week was titled [Work with cool people on stuff that you love](http://wiobyrne.com/work-with-cool-people-on-stuff-that-you-love/). This was really an open letter to some of my colleagues as we start the new year and new initiatives. It's also a call to inspire all of you and promote innovation.

You can contact me for this...or any other request at wiobyrne@gmail.com or reach out on [Twitter](https://twitter.com/wiobyrne). To review past issues please [click here](http://us11.campaign-archive1.com/home/?u=7b5ee323a16720dad25ff96ff&id=17e92a2ae1).

---

## 🔖 Key Takeaways

- **Fold In Comments**: Transmedia storytelling column submitted to JAAL—please feel free to leave comments on the Google Doc we share in the post. We'll fold in your comments as we go to press.
- **Want to Dig In**: Pew research on parents discussing social norms and acceptable behaviors for online interactions with their children—I want to dig into those elements a bit more to see what and when they're sharing this guidance.
- **I Usually Advise**: In my work I'm often asked about purchase/use of iPads/tablets and the need for keyboards. I usually advise educators to purchase Chromebooks as opposed to iPads for a variety of reasons.
- **Rallying Cry**: Barbara Oakley on MOOCs—the post is a rallying cry for online learning experiences...and a motivating force for those of us trying to build and share them.
- **Eyes Wandering**: I'm fascinated by the role of eye contact, and judgments made about eye contact as we pick up visual cues from others—I often find my eyes wandering around as I carry on discussions and try to make points.

---

## 📺 Watch

### [How do we know what color dinosaurs were? - Len Bloch](https://www.youtube.com/watch?v=qYijAZWdnBk)

[Full Ted-Ed lesson](http://ed.ted.com/lessons/how-do-we-know-what-color-dinosaurs-were-len-bloch)

This video comes from a Ted-Ed lesson available at the link above. I recommend subscribing to the [Ted-Ed YouTube Channel](https://www.youtube.com/channel/UCsooa4yRKGN_zEE8iknghZA). I appreciate videos like this as supplemental content for students in hybrid learning spaces.

The video and teaching materials are suitable for a secondary classroom. The science and vocabulary in the clip may require some extra scaffolding for students. For more support, check out [this post from Richard Byrne](http://www.freetech4teachers.com/2016/01/how-do-we-know-what-color-dinosaurs-were.html).
...
A post from the Books section of the NY Times sharing collections of digitized, open source content made available by the NY Public Library. Their new [Public Domain Collection](http://www.nypl.org/research/collections/digital-collections/public-domain) series just went live, and it offers an incredible collection of resources.
...
### [Pew Research Report on Parents, Teens, and Digital Monitoring](http://www.pewinternet.org/2016/01/07/parents-teens-and-digital-monitoring/)

A new report from the [Pew research Center](http://www.pewresearch.org/). This research examines the beliefs and habits we've had about parents monitoring the social media habits of their children (age 13 - 17).
...
### ["Writing on screens taking off in classroom contexts"](http://www.psfk.com/2016/01/writing-on-screens-classroom-technology-tablet-computing-sandymoor-school.html)
...
### [A new pedagogy is emerging...and online learning is a key contributing factor](http://teachonline.ca/tools-trends/how-teach-online-student-success/new-pedagogy-emerging-and-online-learning-key-contributing-factor)
...
- blended learning
- collaborative approaches to construction of knowledge/building communities of practice
- use of multimedia and open ed resources
- increased learner control, choice, and independence
- anywhere, anytime, and size learning
- new forms of assessment
- self-directed and non-formal online learning

Thanks to [Stephen Downes for the link](http://www.downes.ca/cgi-bin/page.cgi?post=64857).

---

### [Why virtual classes (MOOCs) can be better than real ones](http://nautil.us/issue/29/scaling/why-virtual-classes-can-be-better-than-real-ones)

Fascinating essay in which Dr. Barbara Oakley, an engineering professor at Oakland University defends the use of online educational technologies. She collaborated to create a MOOC on the general art of learning. This course was identified as one of the [most popular online courses available](http://bits.blogs.nytimes.com/2015/12/29/the-most-popular-online-course-teaches-you-to-learn/?_r=0). The course is available on Coursera and had 1,192,697 students enrolled the last time it was offered by the University of California.
...
As you read this essay, I recommend checking out [this piece](http://hechingerreport.org/data-mining-shows-that-recorded-video-lectures-are-the-least-effective-way-to-learn/) about the role of video lectures in online courses.

---

### [Pupil Size: A measure of trust?](http://www.scientificamerican.com/article/pupil-size-a-measure-of-trust/)

Intriguing piece of research and discussion about eye contact and "pupil size" and human interactions.

The research appeared in [Psychological Science](http://pss.sagepub.com/content/early/2015/07/30/0956797615588306.abstract) and it suggests that participants trusted partners with dilating pupils and withheld trust from participants that had constricting pupils. They also suggest an element of mimicry in terms of pupil dilation when we're meeting with people that we trust, or have a bond with.
...
### [A seven part series on video editing fundamentals](http://wistia.com/library/editing-your-business-video)
...
**Previous**: [[03 CREATE/33 Newsletter/TLDR 26\|TLDR 26]] • **Next**: [[03 CREATE/33 Newsletter/TLDR 28\|TLDR 28]] • **Archive**: [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]
...
- **[[02 CURATE/Digital Identity\|Digital Identity]]** — Educators create and curate online brand, challenges highlighted.
- **[[03 CREATE/32 Blog/2020/Computational Thinking\|Computational Thinking]]** — JAAL column on coding/programming as literacy activities, computational participation.
- **[[03 CREATE/32 Blog/2015/Transmedia Storytelling\|Transmedia Storytelling]]** — A New Hope column submitted to JAAL, digital storytelling and transmedia narratives.
...
- **[[Slack\|Slack]]** — Using Slack and Trello to organize podcasting series.
- **[[Trello\|Trello]]** — Organizing and planning Research to Practice podcast series.
- **[[Work With Cool People\|Work With Cool People]]** — Open letter to colleagues starting new year, call to inspire and promote innovation.
- **[[Ted-Ed\|Ted-Ed]]** — Dinosaur color video, supplemental content for hybrid learning spaces.
- **[[NYPL\|NYPL]]** — Public domain collection data dumps drowning average person, portal hopes to help make sense.
- **[[Pew Research\|Pew Research]]** — Parents, teens, and digital monitoring, want to dig into social norms guidance.
- **[[Chromebooks vs iPads\|Chromebooks vs iPads]]** — I usually advise Chromebooks opposed to iPads for variety of reasons.
- **[[Proper Kit\|Proper Kit]]** — Might include Chromebook and small tablet, stylus plus bluetooth mouse.
- **[[New Pedagogy\|New Pedagogy]]** — Seven trends emerging, online learning as key contributing factor.
...
- **[[01 CONSUME/16 People/Pablo Picasso\|Pablo Picasso]]** — Paint a wild horse you'll see the wildness not the horse.
