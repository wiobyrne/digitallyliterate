---
{"dg-publish":true,"dg-permalink":"tldr-159","permalink":"/tldr-159/","title":"Too Long; Didn't Read Issue 159","tags":["digital-literacy","education-technology","kathryn-kennedy","career-transitions","following-passions","teaching-with-technology","instructional-technology","literacy-practices","james-bridle","childrens-youtube","elsagate","algorithmic-content","mark-zuckerberg","holocaust-denial","content-moderation","mike-caulfield","disinformation","informational-environment","verification-skills","anonymous-data","data-fingerprints","re-identification","privacy-law","social-media-anxiety","youth-mental-health","fomo","dark-patterns","ux-manipulation","harry-brignull","stress-management","brain-training","francois-nars","balance"],"dg-note-properties":{"title":"Too Long; Didn't Read Issue 159","created":"2018-07-20","last_updated":"2025-12-13","status":"🌲_evergreen","categories":"Newsletter","tags":["digital-literacy","education-technology","kathryn-kennedy","career-transitions","following-passions","teaching-with-technology","instructional-technology","literacy-practices","james-bridle","childrens-youtube","elsagate","algorithmic-content","mark-zuckerberg","holocaust-denial","content-moderation","mike-caulfield","disinformation","informational-environment","verification-skills","anonymous-data","data-fingerprints","re-identification","privacy-law","social-media-anxiety","youth-mental-health","fomo","dark-patterns","ux-manipulation","harry-brignull","stress-management","brain-training","francois-nars","balance"],"connections":["[[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]","[[Childrens YouTube Nightmare\|Childrens YouTube Nightmare]]","[[Disinformation Tactics\|Disinformation Tactics]]","[[Anonymous Data Myth\|Anonymous Data Myth]]","[[Dark Patterns Design\|Dark Patterns Design]]"],"shelf":"archived","description":"Issue 159 balance between anonymity and general disinformation explores Kathryn Kennedy on career transitions following passions, James Bridle uncovering dark corner of children's YouTube where algorithmic content exploits and terrifies young minds, Mark Zuckerberg Holocaust denial controversy revealing content moderation challenges, Mike Caulfield arguing disinformation aims to render informational environment inoperable eliminating accuracy bias and trust, anonymous data easily used to identify individuals through fingerprinting, social media anxiety among youth, dark patterns in UX design obfuscating simple steps, and stress management techniques."}}
---
...
**Published**: 2018-07-20 • [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

Welcome to Issue 159. Balance between anonymity and general disinformation.

This week I posted the following:

- [Four Questions For Kathryn Kennedy about following your passions](https://breadcrumbs.wiobyrne.com/kathryn-kennedy/) - In this discussion with Kathryn Kennedy, I talk about the current transitions in her career. We discuss the guidance, focus, and balance needed to make these changes while listening to your dreams and desires.
- [Making sense of teaching, learning, & assessment with technology](https://wiobyrne.com/teaching-learning-assessing-with-technology/) - A review of teaching with tech. Moving from educational technology, to instructional technology, to literacy practices.
...
### [The nightmare of children's YouTube (16:32)](https://www.youtube.com/watch?v=v9EKV2nSU8w)
...
### [Mark Zuckerberg and Holocaust denial](https://www.recode.net/2018/7/18/17575156/mark-zuckerberg-interview-facebook-recode-kara-swisher)
...
Zuckerberg's comments drew [immediate condemnation on social media](https://breadcrumbs.wiobyrne.com/twitter-thread-from-studio-glibly-nototally/), in the [press](https://www.nytimes.com/2018/07/19/technology/facebook-misinformation.html), and among civil rights activists. He quickly [tried to walk back his statements](https://money.cnn.com/2018/07/18/technology/zuckerberg-recode-holocaust/index.html).
...
### [This is what disinformation looks like](https://breadcrumbs.wiobyrne.com/this-is-what-disinformation-looks-like/)
...
Mike also shares this [playlist on Online Verification Skills](https://www.youtube.com/watch?v=yBU2sDlUbp8&list=PLsSbsdukQ8VYy88IiSJhz4NyBxxtLzsNr&index=1) to assist in your instruction and own learning.
...
### ['Data is a fingerprint': why you aren't as anonymous as you think online](https://www.theguardian.com/world/2018/jul/13/anonymous-browsing-data-medical-records-identity-privacy)
...
### [What parents need to know about social media and anxiety](https://www.huffingtonpost.com/entry/what-parents-need-to-know-about-social-media-and-anxiety_us_5b46993de4b09e77f133df46)
...
### [How to notice and avoid dark patterns online](https://lifehacker.com/how-to-notice-and-avoid-dark-patterns-online-1827734449)
...
This [video by The Nerdwriter](https://www.youtube.com/watch?v=kxkrdLI6e6M) helpfully explains dark patterns and gives some classic examples of different types you'll encounter around the web. It can also be viewed at [darkpatterns.org](http://darkpatterns.org/), a site conceived by UX researcher Harry Brignull.

The site also includes a [Hall of Shame](https://darkpatterns.org/hall-of-shame) of examples collected on Twitter, and deeper dives into the [different types of dark pattern](https://darkpatterns.org/types-of-dark-pattern).
...
### [Train your brain to feel better with these 4 techniques](https://theconversation.com/reeling-from-the-news-train-your-brain-to-feel-better-with-these-4-techniques-100144)
...
1. **See stress as a moment of opportunity** - Reframe stress as signal for growth rather than threat
2. **Check your stress number** - Use 1-5 scale to become aware of stress levels
3. **Update your unconscious expectations** - Identify and challenge automatic negative thoughts
4. **The power of compassion and humor** - Practice self-compassion and find humor in situations
...
**Previous**: [[03 CREATE/33 Newsletter/TLDR 158\|TLDR 158]] • **Next**: [[03 CREATE/33 Newsletter/TLDR 160\|TLDR 160]] • **Archive**: [[03 CREATE/33 Newsletter/📧 Newsletter\|📧 Newsletter]]

**🌱 Connected Concepts**:

- [[Childrens YouTube Nightmare\|Childrens YouTube Nightmare]] — [[James Bridle\|James Bridle]] reveals algorithmic content exploiting young children through disturbing mashups generating advertising revenue demonstrating how platforms optimizing for engagement without oversight produce harmful outcomes in [[Algorithmic Content\|Algorithmic Content]] and [[Platform Responsibility\|Platform Responsibility]].
- [[Disinformation Tactics\|Disinformation Tactics]] — [[Mike Caulfield\|Mike Caulfield]] argues disinformation aims to render [[Informational Environment\|Informational Environment]] inoperable eliminating accuracy bias and trust so only power remains requiring love of distinguishing truth rather than universal skepticism in [[01 CONSUME/10 Inbox/Media Literacy\|Media Literacy]].
- [[Anonymous Data Myth\|Anonymous Data Myth]] — Guardian investigation reveals so-called anonymous data serves as fingerprint easily used to identify individuals through cross-referencing patterns demonstrating fragility of anonymization and need for stronger custodian obligations in [[Privacy Protection\|Privacy Protection]].
- [[Dark Patterns Design\|Dark Patterns Design]] — [[Harry Brignull\|Harry Brignull]]'s darkpatterns.org documents UX manipulation techniques deliberately designed to trick users into actions serving company interests over user welfare requiring recognition as essential [[02 CURATE/Digital Literacy Framework\|Digital Literacy Framework]] skill in [[Interface Design\|Interface Design]].
- [[Youth Social Media Anxiety\|Youth Social Media Anxiety]] — Parental guidance needed as teens navigate [[Social Media\|Social Media]] landscape experiencing cyberbullying FOMO and harassment recognizing cutting off access creates isolation rather than solving problems requiring engagement without invasion in [[02 CURATE/Digital Citizenship\|Digital Citizenship]].
