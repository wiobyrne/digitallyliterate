---
{"dg-publish":true,"permalink":"/03-create/presentations/lra-2025/framework-component-inputs-m-and-m/","title":"Framework Component - Inputs (M&M)","tags":["framework-component","inputs","source-curation","agency","AI-literacy","NotebookLM"]}
---

# Framework Component: Inputs (M&M)
...
This component captures **[[03 CREATE/🌲 Evergreens/Agency\|Agency]] over Knowledge Base:**
...
Students engage in [[03 CREATE/🌲 Evergreens/Boundary-work\|Boundary-work]] at the input stage by:
...
- **→ [[03 CREATE/📊 Presentations/LRA 2025/Framework Component: Prompts (M&M)\|Framework Component: Prompts (M&M)]]:** Inputs establish context; prompts direct interaction
- **→ [[03 CREATE/📊 Presentations/LRA 2025/Framework Component: Outputs (M&M)\|Framework Component: Outputs (M&M)]]:** Quality of inputs influences output quality
- **→ [[03 CREATE/📊 Presentations/LRA 2025/Framework Component: Integration (M&M)\|Framework Component: Integration (M&M)]]:** Source selection affects what students integrate
...
#framework-component #inputs #source-curation #agency #AI-literacy
