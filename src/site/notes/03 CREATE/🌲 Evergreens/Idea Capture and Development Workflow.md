...
### Other Actions:
- **File elsewhere**: If it's reference material (→ CONSUME folders)
- **Add to existing note**: If it extends current content
- **Delete**: If no longer relevant

---

## Stage 3: Seed Development (🌱)
