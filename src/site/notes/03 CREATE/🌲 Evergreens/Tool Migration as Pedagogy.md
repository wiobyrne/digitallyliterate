---
{"dg-publish":true,"dg-permalink":"tool-migration-as-pedagogy","permalink":"/tool-migration-as-pedagogy/","title":"Tool Migration as Pedagogy","tags":["pedagogy","digital-literacy","tool-migration","authentic-assessment","experiential-learning","critical-pedagogy"]}
---
...
**Encryption and privacy** — Zero-knowledge architecture stops being abstract when someone has to trust a system that, by design, can't read their files. [[03 CREATE/🪴 Groves/Privacy by Design\|Privacy by Design]] moves from principle to practice.

**Decentralization and federation** — Federated networks become tangible when learners understand why their Matrix account can communicate with accounts on other servers — and what control that gives them. This is [[03 CREATE/🌲 Evergreens/Digital Sovereignty\|Digital Sovereignty]] experienced, not described.
...
- [[03 CREATE/🪴 Groves/Teaching Philosophy\|Teaching Philosophy]] — The pedagogical principles that make this approach coherent
