---
{"dg-publish":true,"permalink":"/03-create/evergreens/platform-capture-and-knowledge-liberation/","title":"Platform Capture and Knowledge Liberation","tags":["digital-garden","platform-capture","plain-text","knowledge-management","AI-voice","newsletter"]}
---
...
- It existed in proprietary formats
- It was locked behind interfaces I didn't control
- Old ideas sank out of sight as new ones piled on top
- Nothing connected
...
- How thinking about AI evolved from curiosity to critical skepticism
- Threads of surveillance capitalism or digital literacy principles developing across years
- The arc of the newsletter itself—not just what was written, but how the approach changed
...
- Git version control over platform databases
- Self-hosted over vendor-locked
- Resistance to extraction
- Preservation of agency
- Building for durability rather than convenience
...
- How do you maintain the garden without it becoming a full-time job?
- What's the right balance between connection and noise—when does linking become clutter?
- How do you invite readers into a garden without overwhelming them with structure they didn't ask for?
- If platforms fail "when, not if"—what's the preservation strategy beyond plain text and Git?
