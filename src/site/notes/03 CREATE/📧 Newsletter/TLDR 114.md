---
{"dg-publish":true,"dg-permalink":"tldr-114","permalink":"/tldr-114/","title":"Too Long; Didn't Read Issue 114","tags":["digital-literacy","education-technology"]}
---
...
**Published**: 2017-09-09 • [[03 CREATE/📧 Newsletter/📧 Newsletter\|📧 Newsletter]]

Welcome to TL;DR #114 (September 9th, 2017)

View this email in your browser

** Too Long; Didn't Read (TL;DR) newsletter #114

------------------------------------------------------------

Welcome to issue #114 of TL;DR. Someday we'll find it, the rainbow connection.
...
** Where do new words come from? (5:43) (https://www.youtube.com/watch?v=Ytr28t5VzAs)
...
The lesson plan for this episode is ** available here (https://ed.ted.com/lessons/where-do-new-words-come-from-marcel-danesi)

. Also check out the ** Mysteries of Vernacular series on TED-Ed (https://ed.ted.com/mysteries-of-vernacular)
...
This post from ** Erika Christakis (https://twitter.com/ErikaChristakis)

in ** The Atlantic (https://www.theatlantic.com/)
...
This piece by ** Matt Haig (https://twitter.com/matthaig1)

spurred a lot of discussion this week...strangely in my social media circles. :)

Haig discusses the harm that can be caused by social media, as well as Internet addiction and "filter bubbles." ** Stephen Downes effectively discusses (http://www.downes.ca/cgi-bin/page.cgi?post=67192)

the challenges in these areas, as well as the challenges with the writing of this specific post.
...
For now, the "answer" might be to sit down with a ** Sherry Turkle (https://twitter.com/STurkle)

book to find some balance in these discussions.
...
A good example of this is the work from the ** Virtually Connecting (http://virtuallyconnecting.org/)
...
This post does an excellent job of detailing how to make Socratic Seminars happen in your classroom, and how to connect this to important 21st Century Skills. ** Mari Venturino (https://twitter.com/MsVenturino)

provides granular advice on how to make this happen, while focusing on the "4C's" of critical thinking, communication, collaboration, and creativity.
...
Too Long; Didn't Read (TL;DR) #114
...
**Previous**: [[03 CREATE/📧 Newsletter/TLDR 113\|TLDR 113]] • **Next**: [[03 CREATE/📧 Newsletter/TLDR 115\|TLDR 115]] • **Archive**: [[03 CREATE/📧 Newsletter/📧 Newsletter\|📧 Newsletter]]
