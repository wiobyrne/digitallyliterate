---
{"dg-publish":true,"dg-permalink":"tldr-4","permalink":"/tldr-4/","title":"Too Long; Didn't Read Issue 4","tags":["digital-literacy","education-technology","web-literacy","digital-badges","privacy","sharenting","social-media","agile-methodology","digital-wisdom","accessibility","multimodal-learning","digital-divide"]}
---
...
The next five billion Internet users will primarily be non-native English speakers. For the most part, the Internet will be a vastly different place. This piece from [PSFK](http://www.psfk.com/author/psfk)
discusses the challenges and opportunities that exist as businesses and individuals strive to connect and profit in this transition.
...
This piece from [Hybrid Pedagogy](http://www.hybridpedagogy.com/)
examines the author's quest not to have students gain "digital literacy" but instead find "digital wisdom." Adam Copeland builds off from [Marc Prensky's definition](https://web.archive.org/web/20130317032846/http://innovateonline.info/pdf/vol5_issue3/H._Sapiens_Digital-__From_Digital_Immigrants_and_Digital_Natives_to_Digital_Wisdom.pdf)
of digital wisdom as being "a twofold concept, referring both to wisdom arising from the use of digital technology to access cognitive power beyond our innate capacity and to wisdom in the prudent use of technology to enhance our capabilities.”
...
- **[[Web Literacy\|Web Literacy]]** — Interviews with web literacy experts on Mozilla's framework.
- **[[Digital Badges\|Digital Badges]]** — Katerina Schenke on recognition and motivation in learning.
- **[[Privacy and Security\|Privacy and Security]]** — Sharenting: balancing family sharing with children's digital privacy.
- **[[Social Media Research\|Social Media Research]]** — Pew Research on parent social media usage patterns.
- **[[Agile Methodology\|Agile Methodology]]** — Applying software development workflows to education.
- **[[02 DEVELOP/🌿 Plants/Digital Divide\|Digital Divide]]** — The next 5 billion users and the changing global internet.
- **[[Digital Wisdom\|Digital Wisdom]]** — Marc Prensky's concept beyond digital natives/immigrants.
- **[[Web Design\|Web Design]]** — Asymmetrica and neuroscience-based readability improvements.
- **[[Multimodal Learning\|Multimodal Learning]]** — Creating GIFs and visual tutorials for explanation.
- **[[Accessibility\|Accessibility]]** — Text-to-speech in Pocket for diverse learning needs.
