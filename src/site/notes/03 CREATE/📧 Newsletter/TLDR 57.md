---
{"dg-publish":true,"dg-permalink":"tldr-57","permalink":"/tldr-57/","title":"Too Long; Didn't Read Issue 57","tags":["digital-literacy","education-technology"]}
---
...
**Published**: 2016-08-05 • [[03 CREATE/📧 Newsletter/📧 Newsletter\|📧 Newsletter]]

Welcome to TL;DR #57 (August 5th, 2016)

View this email in your browser

** Too Long; Didn't Read (TL;DR) newsletter #57
...
Seymour Papert and Paulo Friere debate technology and the future of schools
...
** passed away this week (http://www.nytimes.com/2016/08/02/technology/seymour-papert-88-dies-saw-educations-future-in-computers.html?_r=1)

at the age of 88. Papert was a mathematician, computer scientist, and educator who was a pioneer of artificial intelligence and of the constructionist movement. For a full listing of some of the tributes to him online, please review ** this post (http://www.downes.ca/cgi-bin/page.cgi?post=65626)

from ** Stephen Downes (https://twitter.com/oldaily)

.

This post is a transcript of the intro to the Seymour Papert tribute at the Interaction Design for Children conference in 2013. In the piece, ** Paulo Bilkstein (https://twitter.com/PauloBlikstein)
...
Post by ** Andrew Marcinek (https://twitter.com/andycinek)

asking that we authentically and effectively integrate technology into education...as opposed to viewing it as an additive to pedagogy.
...
Post from ** Kristen Mattson (https://twitter.com/mrskmattson)

providing a counter argument to much of the recent discussion about digital citizenship (** #digcit (https://twitter.com/hashtag/digcit)
...
Post from ** The Hechinger Report (http://hechingerreport.org/)

in ** Wired (http://www.wired.com/)

examining a "school" that really allows for student voice and choice in a blended learning environment. New Hampshire's self-paced Virtual Learning Academy Charter School (VLACS) serves about 200 full-time middle and high school, as well as about 10,000 part-time students from across the state.
...
** Sean Captain (https://twitter.com/seancaptain)

in ** Fast Company (http://www.fastcompany.com/)

looks at the digital residue that we've left behind as we interact with technologies and asks whether or not we have the tools to create artificially intelligent versions of ourselves.
...
Until that point arrives, I've been search for ways to help my students consume and synthesize the videos that I share in class. I typically will use ** Vialogues (https://vialogues.com/)

(and will start testing ** VideoAnt (https://ant.umn.edu/)

) to allow students to have time-stamped discussions on the video. I'll also start playing with this beta version of ** BriefTube (https://chrome.google.com/webstore/detail/brieftube-instant-video-s/gfckdcbnnkobldfaefmhaigdolfniill/)

to add some context to the content they consume.
...
**Previous**: [[03 CREATE/📧 Newsletter/TLDR 56\|TLDR 56]] • **Next**: [[03 CREATE/📧 Newsletter/TLDR 58\|TLDR 58]] • **Archive**: [[03 CREATE/📧 Newsletter/📧 Newsletter\|📧 Newsletter]]
