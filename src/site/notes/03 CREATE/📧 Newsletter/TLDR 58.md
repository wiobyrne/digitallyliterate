---
{"dg-publish":true,"dg-permalink":"tldr-58","permalink":"/tldr-58/","title":"Too Long; Didn't Read Issue 58","tags":["digital-literacy","education-technology"]}
---
...
Welcome to TL;DR #58 (August 12th, 2016)

View this email in your browser

** Too Long; Didn't Read (TL;DR) newsletter #58
...
** Seth Godin Returns (Full Episode) | The Tim Ferriss Show (Podcast) (https://youtu.be/GM9xKm7MIpU?t=2m39s)
...
recently returned to ** The Tim Ferris Show (http://fourhourworkweek.com/blog/)

## 📚 Read

This week there was a flurry of discussion online after this post on the ** Academics Anonymous (https://www.theguardian.com/higher-education-network/series/academics-anonymous)

section of ** The Guardian's Higher Education Network (https://www.theguardian.com/higher-education-network)

. I recommend reviewing ** this response (https://www.theguardian.com/science/brain-flapping/2016/aug/05/im-a-non-serious-academic-i-make-no-apologies-for-this)

from ** Dean Burnett (https://twitter.com/garwboy)

and ** this response (http://www.thetattooedprof.com/archives/630)

from ** Kevin Gannon (https://twitter.com/@TheTattooedProf)

. I'd also recommend checking out the ** #seriousacademic (https://twitter.com/search?q=%23seriousacademic&src=tyah)

hashtag on Twitter.

I'm working on a response to these discussions and most likely this will dovetail with the chapter submission I shared above, and ** this post (http://wiobyrne.com/three-steps-digitally-agile-educator/)

I shared last month. I think there is a lot of value in using social and digital tools for research, teaching, and service. As with all literacy practices, I think it has to come down to why you're using these tools.
...
Post by ** Erica Hodgin (https://twitter.com/EricaHodgin)

on ** DML Central (http://dmlcentral.net/)

sharing opportunities to engage learners in participatory politics. This post builds on ** a recent publication (http://www.tandfonline.com/doi/full/10.1080/00933104.2015.1132646)

from Erica, ** Joseph Kahne (https://twitter.com/jkahne)

, and ** Elyse Eidman-Aadahl (https://twitter.com/ElyseEA)
...
** Anya Kamenetz (https://twitter.com/anya1anya)

on the MindShift blog discussing connections between student achievement and digital tool use.
...
Editorial in the NY Times from ** Tony Marx (https://www.nypl.org/help/about-nypl/president-and-leadership)

, President and CEO of the NY Public Library. Tony discusses the role of the library system in providing internet access for citizens in the NY area that need it the most. He then indicates that the library system cannot do this alone. We need to provide all citizens with affordable opportunities to access high speed, high quality broadband.

Luckily, the FCC seems ** interested in closing this digital divide (http://www.nytimes.com/2016/06/09/technology/the-challenges-of-closing-the-digital-divide.html?rref=collection%2Ftimestopic%2FFederal%20Communications%20Commission)
...
This week in TL;DR we've been talking about whether you can, or should be able to be a digital citizen. This post from ** David Weinberger (https://twitter.com/dweinberger)

discusses the recent work by ** Tim Berners-Lee (https://twitter.com/timberners_lee)

to decentralize the web.
...
Guidance from ** Jon Pennington (https://twitter.com/@JDPennington)

on EdSurge on using voice dictation with students as part of their work process.
