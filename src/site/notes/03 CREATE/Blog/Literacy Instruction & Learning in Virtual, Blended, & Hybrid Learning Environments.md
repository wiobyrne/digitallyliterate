...
Kristy and I were also invited by the Michigan Virtual Learning Research Institute (MVLRI) to conduct a webinar discussing the chapter. You can review the video from the webinar below. Beneath the video I embedded our [presentation slides](https://docs.google.com/presentation/d/1B-PJRx87nIb9TXux7PWeSjTxR8peK5lmgu5-ce_rSC8/edit?usp=sharing). You can access the chat from the webinar by [clicking here](https://www.scribd.com/doc/260501803/Chat-3-11-2015-Research-on-Literacy-Instruction-and-Learning-in-Virtual-Blended-and-Hybrid-Environments#scribd).
