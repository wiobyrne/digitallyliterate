...
1. **AI as amplifier, not replacement** — Your professional judgment stays central
2. **Critical engagement** — Question the tools, don't just use them
3. **Ethical awareness** — Consider costs, biases, and implications
4. **Practical application** — Leave with usable resources
...
- [ ] A classroom-ready unit on a wicked problem
- [ ] Custom AI prompts and tools
- [ ] Strategies for teaching AI literacy to students
- [ ] A personal workflow for AI-assisted planning
